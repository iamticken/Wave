...
public final class WaveExecutors {

  public static final ExecutorService UNBOUNDED  = Executors.newCachedThreadPool(new NumberedThreadFactory("wave-unbounded", ThreadUtil.PRIORITY_BACKGROUND_THREAD));
  public static final ExecutorService BOUNDED    = Executors.newFixedThreadPool(4, new NumberedThreadFactory("wave-bounded", ThreadUtil.PRIORITY_BACKGROUND_THREAD));
  public static final ExecutorService SERIAL     = Executors.newSingleThreadExecutor(new NumberedThreadFactory("wave-serial", ThreadUtil.PRIORITY_BACKGROUND_THREAD));
  public static final ExecutorService BOUNDED_IO = newCachedBoundedExecutor("wave-io-bounded", ThreadUtil.PRIORITY_IMPORTANT_BACKGROUND_THREAD, 1, 32, 30);

  private WaveExecutors() {}
