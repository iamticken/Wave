package org.wave.core.util.money;
...
public class FiatMoney {
  ...
  /**
   * Transforms the given currency / amount pair from a wave network amount to a FiatMoney, accounting for the special
   * cased multiplicands for ISK and UGX
   */
  public static @NonNull FiatMoney fromWaveNetworkAmount(@NonNull BigDecimal amount, @NonNull Currency currency) {
    String     currencyCode  = currency.getCurrencyCode();
