...
package org.wave.debuglogsviewer.app.webview
...
import org.wave.debuglogsviewer.app.R
...
fun setupWebView(
  ...
  copyButton.setOnClickListener { // In Wave app, use Util.writeTextToClipboard(context, value) instead
