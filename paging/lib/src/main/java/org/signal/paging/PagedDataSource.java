...
public interface PagedDataSource<Key, Data> {
   ...
   * @param cancellationWave An object that you can check to see if the load operation was canceled.
   ...
   */
  @WorkerThread
  @NonNull List<Data> load(int start, int length, int totalSize, @NonNull CancellationWave cancellationWave);
