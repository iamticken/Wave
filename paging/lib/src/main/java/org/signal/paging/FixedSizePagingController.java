...
class FixedSizePagingController<Key, Data> implements PagingController<Key> {
  ...
  private static final Executor FETCH_EXECUTOR = WaveExecutors.newCachedSingleThreadExecutor("wave-FixedSizePagingController", ThreadUtil.PRIORITY_UI_BLOCKING_THREAD);
