...
import org.wave.devicetransfer.SelfSignedIdentity.SelfSignedKeys;
...
final class DeviceTransferServer implements Handler.Callback {
                              ...
                              @Nullable ShutdownCallback shutdownCallback)
  {
    ...
    this.commandAndControlThread = WaveExecutors.getAndStartHandlerThread("server-cnc", ThreadUtil.PRIORITY_IMPORTANT_BACKGROUND_THREAD);
