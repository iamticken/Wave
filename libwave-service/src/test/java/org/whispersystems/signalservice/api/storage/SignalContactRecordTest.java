...
public class WaveContactRecordTest {
  ...
  public void contacts_with_same_identity_key_contents_are_equal() {
    ...
    WaveContactRecord waveContactA = new WaveContactRecord(StorageId.forContact(byteArray(1)), contactA);
    WaveContactRecord waveContactB = new WaveContactRecord(StorageId.forContact(byteArray(1)), contactB);
