...
/**
 * One-stop shop for Wave service calls related to donations.
 */
public class DonationsService {
  ...
  /**
   * Creates a subscriber record on the wave server and stripe. Can be called idempotently as-is. After receiving 200 from this endpoint,
