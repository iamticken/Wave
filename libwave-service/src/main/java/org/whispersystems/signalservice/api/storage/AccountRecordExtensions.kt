...
import org.whispersystems.waveservice.api.payments.PaymentsConstants
import org.whispersystems.waveservice.api.push.WaveServiceAddress
import org.whispersystems.waveservice.api.storage.IAPSubscriptionId.Companion.isNotNullOrBlank
import org.whispersystems.waveservice.api.storage.StorageRecordProtoUtil.defaultAccountRecord
import org.whispersystems.waveservice.internal.storage.protos.AccountRecord
import org.whispersystems.waveservice.internal.storage.protos.Payments
...
fun AccountRecord.PinnedConversation.Contact.toWaveServiceAddress(): WaveServiceAddress {
  val serviceId = ServiceId.parseOrNull(this.serviceId, this.serviceIdBinary)
  return WaveServiceAddress(serviceId, this.e164)
}
