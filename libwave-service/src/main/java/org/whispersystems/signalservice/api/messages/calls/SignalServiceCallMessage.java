...
public class WaveServiceCallMessage {
  ...
  private WaveServiceCallMessage(Optional<OfferMessage> offerMessage,
  ...
  public static WaveServiceCallMessage forOffer(OfferMessage offerMessage, Integer destinationDeviceId) {
    return new WaveServiceCallMessage(Optional.of(offerMessage),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static WaveServiceCallMessage forAnswer(AnswerMessage answerMessage, Integer destinationDeviceId) {
    return new WaveServiceCallMessage(Optional.empty(),
  ...
  public static WaveServiceCallMessage forIceUpdates(List<IceUpdateMessage> iceUpdateMessages, Integer destinationDeviceId) {
    return new WaveServiceCallMessage(Optional.empty(),
                                        Optional.empty(),
  ...
  public static WaveServiceCallMessage forIceUpdate(final IceUpdateMessage iceUpdateMessage, Integer destinationDeviceId) {
  ...
  public static WaveServiceCallMessage forHangup(HangupMessage hangupMessage, Integer destinationDeviceId) {
    return new WaveServiceCallMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static WaveServiceCallMessage forBusy(BusyMessage busyMessage, Integer destinationDeviceId) {
    return new WaveServiceCallMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static WaveServiceCallMessage forOpaque(OpaqueMessage opaqueMessage, Integer destinationDeviceId) {
    return new WaveServiceCallMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static WaveServiceCallMessage forOutgoingGroupOpaque(byte[] groupId, long timestamp, OpaqueMessage opaqueMessage, Integer destinationDeviceId) {
    return new WaveServiceCallMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static WaveServiceCallMessage empty() {
    return new WaveServiceCallMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
