package org.whispersystems.waveservice.api.messages.shared;
...
public class SharedContact {
  ...
  public static class Avatar {
    private final WaveServiceAttachment attachment;
    private final boolean                 isProfile;

    public Avatar(WaveServiceAttachment attachment, boolean isProfile) {
      this.attachment = attachment;
      this.isProfile  = isProfile;
    }

    public WaveServiceAttachment getAttachment() {
      return attachment;
    }
    ...
    public static class Builder {
      private WaveServiceAttachment attachment;
      private boolean                 isProfile;

      public Builder withAttachment(WaveServiceAttachment attachment) {
        this.attachment = attachment;
        return this;
      }
