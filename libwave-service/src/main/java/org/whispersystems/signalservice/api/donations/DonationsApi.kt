...
import org.whispersystems.waveservice.internal.push.BankMandate
...
/**
 * One-stop shop for Wave service calls related to in-app payments.
 *
 * Be sure to check for cached versions of these methods in DonationsService before calling these methods elsewhere.
 */
class DonationsApi(private val authWebSocket: WaveWebSocket.AuthenticatedWebSocket, private val unauthWebSocket: WaveWebSocket.UnauthenticatedWebSocket) {
  ...
  /**
   * Creates a subscriber record on the wave server.
   *
