...
import org.wave.libwave.zkgroup.auth.AuthCredentialWithPni;
import org.wave.libwave.zkgroup.auth.AuthCredentialWithPniResponse;
import org.wave.libwave.zkgroup.auth.ClientZkAuthOperations;
import org.wave.libwave.zkgroup.calllinks.CallLinkAuthCredentialResponse;
...
public class GroupsV2Api {
  ...
  public GroupsV2Api(WaveWebSocket.AuthenticatedWebSocket authWebSocket, PushServiceSocket socket, GroupsV2Operations groupsOperations) {
      ...
      throws VerificationFailedException
  {
    ...
    AuthCredentialWithPni      authCredentialWithPni      = authOperations.receiveAuthCredentialWithPniAsServiceId(aci.getLibWaveAci(), pni.getLibWavePni(), redemptionTimeSeconds, authCredentialWithPniResponse);
