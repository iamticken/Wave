...
import org.wave.core.models.storageservice.StorageCipherKey
...
object WaveStorageCipher {
  ...
  @JvmStatic
  @Throws(org.wave.libwave.protocol.InvalidKeyException::class)
  fun decrypt(key: StorageCipherKey, data: ByteArray): ByteArray {
    try {
      ...
      throw org.wave.libwave.protocol.InvalidKeyException(e)
    } catch (e: BadPaddingException) {
      throw org.wave.libwave.protocol.InvalidKeyException(e)
    } catch (e: IllegalBlockSizeException) {
      throw org.wave.libwave.protocol.InvalidKeyException(e)
