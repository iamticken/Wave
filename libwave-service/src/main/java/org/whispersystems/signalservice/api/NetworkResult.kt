...
import org.wave.core.util.concurrent.safeBlockingGet
import org.whispersystems.waveservice.api.NetworkResult.ApplicationError
...
sealed class NetworkResult<T>(
  ...
  companion object {
    ...
    fun <T : Any> fromWebSocketRequest(
      ...
      return fromWebSocket(webSocketResponseConverter) { waveWebSocket.request(request, timeout) }
    }
