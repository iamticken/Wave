...
import org.whispersystems.waveservice.internal.push.Envelope.Type;
...
public interface EnvelopeContent {
   ...
   */
  OutgoingPushMessage processSealedSender(WaveSessionCipher sessionCipher,
                                          WaveSealedSessionCipher sealedSessionCipher,
                                          WaveProtocolAddress destination,
   ...
   */
  OutgoingPushMessage processUnsealedSender(WaveSessionCipher sessionCipher, WaveProtocolAddress destination) throws UntrustedIdentityException, NoSessionException;
  ...
  class Encrypted implements EnvelopeContent {
    ...
    @Override
    public OutgoingPushMessage processSealedSender(WaveSessionCipher sessionCipher,
                                                   WaveSealedSessionCipher sealedSessionCipher,
                                                   WaveProtocolAddress destination,
                                                   SenderCertificate senderCertificate)
        throws UntrustedIdentityException, InvalidKeyException, NoSessionException
    ...
    @Override
    public OutgoingPushMessage processUnsealedSender(WaveSessionCipher sessionCipher, WaveProtocolAddress destination) throws UntrustedIdentityException, NoSessionException {
      PushTransportDetails transportDetails     = new PushTransportDetails();
      CiphertextMessage    message              = sessionCipher.encrypt(transportDetails.getPaddedMessageBody(content.encode()));
  ...
  class Plaintext implements EnvelopeContent {
    ...
    @Override
    public OutgoingPushMessage processUnsealedSender(WaveSessionCipher sessionCipher, WaveProtocolAddress destination) {
