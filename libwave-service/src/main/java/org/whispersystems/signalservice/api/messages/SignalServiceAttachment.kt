...
abstract class WaveServiceAttachment protected constructor(val contentType: String?) {
  abstract fun isStream(): Boolean
  abstract fun isPointer(): Boolean

  fun asStream(): WaveServiceAttachmentStream {
    return this as WaveServiceAttachmentStream
  }

  fun asPointer(): WaveServiceAttachmentPointer {
    return this as WaveServiceAttachmentPointer
  }
  ...
  class Builder {
    ...
    private var cancelationWave: CancelationWave? = null
    ...
    fun withCancelationWave(cancelationWave: CancelationWave?): Builder {
      this.cancelationWave = cancelationWave
      return this
    }
