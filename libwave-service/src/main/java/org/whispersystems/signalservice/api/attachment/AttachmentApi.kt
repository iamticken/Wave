...
class AttachmentApi(
   ...
   */
  fun uploadAttachmentV4(attachmentStream: WaveServiceAttachmentStream): NetworkResult<AttachmentUploadResult> {
    ...
    return NetworkResult.fromFetch {
      ...
      val attachmentData = PushAttachmentData(
        ...
        cancelationWave = attachmentStream.cancelationWave,
      ...
      AttachmentUploadResult(
        remoteId = WaveServiceAttachmentRemoteId.V4(attachmentData.resumableUploadSpec.cdnKey),
