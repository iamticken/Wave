...
import org.wave.libwave.zkgroup.backups.BackupAuthCredential
import org.wave.libwave.zkgroup.backups.BackupAuthCredentialRequestContext
import org.wave.libwave.zkgroup.backups.BackupAuthCredentialResponse
import org.whispersystems.waveservice.api.NetworkResult
import org.whispersystems.waveservice.api.archive.ArchiveGetMediaItemsResponse.StoredMediaObject
...
class ArchiveApi(
   ...
   */
  fun uploadBackupFile(uploadForm: AttachmentUploadForm, resumableUploadUrl: String, data: InputStream, dataLength: Long, progressListener: WaveServiceAttachment.ProgressListener? = null): NetworkResult<Unit> {
    return NetworkResult.fromFetch {
   ...
   *
   * This is basically the same as [org.whispersystems.waveservice.api.attachment.AttachmentApi.getAttachmentV4UploadForm], but with a relaxed rate limit
