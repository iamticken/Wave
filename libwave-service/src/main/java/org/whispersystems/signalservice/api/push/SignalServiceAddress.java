 ...
 */
public class WaveServiceAddress {
   ...
   */
  public WaveServiceAddress(ServiceId serviceId, Optional<String> e164) {
    this.serviceId = Preconditions.checkNotNull(serviceId);
    this.e164      = e164;
  }

  @SuppressWarnings("NewApi")
  public WaveServiceAddress(ServiceId serviceId) {
    this.serviceId = Preconditions.checkNotNull(serviceId);
   ...
   */
  public WaveServiceAddress(ServiceId serviceId, String e164) {
  ...
  public boolean matches(WaveServiceAddress other) {
  ...
  public static Optional<WaveServiceAddress> fromRaw(String rawUuid, String e164) {
    if (isValidAddress(rawUuid, e164)) {
      return Optional.of(new WaveServiceAddress(ServiceId.parseOrThrow(rawUuid), e164));
    } else {
  ...
  @Override public boolean equals(Object o) {
    ...
    final WaveServiceAddress that = (WaveServiceAddress) o;
