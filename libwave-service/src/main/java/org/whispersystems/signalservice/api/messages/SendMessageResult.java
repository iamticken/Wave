...
public class SendMessageResult {
  ...
  private final WaveServiceAddress   address;
  ...
  public static SendMessageResult success(WaveServiceAddress address, List<Integer> devices, boolean unidentified, boolean needsSync, long duration, Optional<Content> content) {
  ...
  public static SendMessageResult networkFailure(WaveServiceAddress address) {
    return new SendMessageResult(address, null, true, false, null, null, null, false, false);
  }

  public static SendMessageResult unregisteredFailure(WaveServiceAddress address) {
    return new SendMessageResult(address, null, false, true, null, null, null, false, false);
  }

  public static SendMessageResult identityFailure(WaveServiceAddress address, IdentityKey identityKey) {
    return new SendMessageResult(address, null, false, false, new IdentityFailure(identityKey), null, null, false, false);
  }

  public static SendMessageResult proofRequiredFailure(WaveServiceAddress address, ProofRequiredException proofRequiredException) {
    return new SendMessageResult(address, null, false, false, null, proofRequiredException, null, false, false);
  }

  public static SendMessageResult rateLimitFailure(WaveServiceAddress address, RateLimitException rateLimitException) {
    return new SendMessageResult(address, null, false, false, null, null, rateLimitException, false, false);
  }

  public static SendMessageResult invalidPreKeyFailure(WaveServiceAddress address) {
    return new SendMessageResult(address, null, false, false, null, null, null, true, false);
  }

  public static SendMessageResult canceledFailure(WaveServiceAddress address) {
    return new SendMessageResult(address, null, false, false, null, null, null, false, true);
  }

  public WaveServiceAddress getAddress() {
    return address;
  }
  ...
  private SendMessageResult(WaveServiceAddress address,
                            Success success,
