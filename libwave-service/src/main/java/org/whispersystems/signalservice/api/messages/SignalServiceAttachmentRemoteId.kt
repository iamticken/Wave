...
/**
 * Represents a wave service attachment identifier. This can be either a CDN key or a long, but
 ...
 */
sealed interface WaveServiceAttachmentRemoteId {

  object S3 : WaveServiceAttachmentRemoteId {
    override fun toString() = ""
  }

  data class V2(val cdnId: Long) : WaveServiceAttachmentRemoteId {
    override fun toString() = cdnId.toString()
  }

  data class V4(val cdnKey: String) : WaveServiceAttachmentRemoteId {
    override fun toString() = cdnKey
  }

  data class Backup(val mediaCdnPath: String, val mediaId: String) : WaveServiceAttachmentRemoteId {
  ...
  companion object {
    ...
    fun from(attachmentPointer: AttachmentPointer): WaveServiceAttachmentRemoteId {
     ...
     */
    @JvmStatic
    fun from(string: String): WaveServiceAttachmentRemoteId {
