package org.whispersystems.waveservice.api.subscriptions;
...
public final class SubscriptionLevels {
  ...
  public static final class Level {
    ...
    private final WaveServiceProfile.Badge badge;
    private final Map<String, BigDecimal>    currencies;

    @JsonCreator
    public Level(@JsonProperty("name") String name,
                 @JsonProperty("badge") WaveServiceProfile.Badge badge,
    ...
    public WaveServiceProfile.Badge getBadge() {
      return badge;
    }
