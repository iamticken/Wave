 ...
 *  - LibWaveChatConnection - the wrapper around libwave's [org.wave.libwave.net.ChatService]
 */
interface WebSocketConnection {
   ...
   * This is specifically for LibWave-based connections to access the native connection.
   *
  ...
  suspend fun <T> runWithChatConnection(callback: (org.wave.libwave.net.ChatConnection) -> T): T {
    // Default implementation for non-LibWave connections
