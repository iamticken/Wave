...
import org.wave.core.util.billing.BillingError
...
internal class BillingApiImpl(
   ...
   */
  override suspend fun getApiAvailability(): org.wave.core.util.billing.BillingResponseCode {
    return try {
      doOnConnectionReady("isApiAvailable") {
        org.wave.core.util.billing.BillingResponseCode.fromBillingLibraryResponseCode(billingClient.isFeatureSupported(BillingClient.FeatureType.SUBSCRIPTIONS).responseCode)
      }
    } catch (e: BillingError) {
      Log.e(TAG, "Failed to connect to Google Play Billing", e, true)
      org.wave.core.util.billing.BillingResponseCode.fromBillingLibraryResponseCode(e.billingResponseCode)
    }
  }
