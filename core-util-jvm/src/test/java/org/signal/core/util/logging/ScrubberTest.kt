...
package org.wave.core.util.logging
  ...
  companion object {
    ...
    fun data(): Iterable<Array<Any>> {
      return listOf(
        ...
        arrayOf(
          "This is not an email Success(result=org.whispersystems.waveservice.api.archive.ArchiveMediaResponse@1ea5e6)",
          "This is not an email Success(result=org.whispersystems.waveservice.api.archive.ArchiveMediaResponse@1ea5e6)"
        ),
        arrayOf(
        ...
        arrayOf(
          "An avatar email filename: file:///data/user/0/org.thoughtcrime.securesms/files/avatars/abc@wave.org",
        ...
        arrayOf(
          "__wave_group__v2__!0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
          "GV2::***def"
        ),
        arrayOf(
          "A group v2 id __wave_group__v2__!23456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef01 surrounded with text",
        ...
        arrayOf(
          "Failed to resolve chat.wave.org using . Continuing.",
          "Failed to resolve chat.wave.org using . Continuing."
        ),
        arrayOf(
          " Caused by: java.io.IOException: unexpected end of stream on Connection{storage.wave.org:443, proxy=DIRECT hostAddress=storage.wave.org/142.251.32.211:443 cipherSuite=TLS_AES_128_GCM_SHA256 protocol=http/1.1}",
          " Caused by: java.io.IOException: unexpected end of stream on Connection{storage.wave.org:443, proxy=DIRECT hostAddress=storage.wave.org/...ipv4...:443 cipherSuite=TLS_AES_128_GCM_SHA256 protocol=http/1.1}"
        ),
        arrayOf(
          "192.168.1.1",
          "...ipv4..."
        ...
        arrayOf(
          "https://wave.org/v1/endpoint",
          "https://wave.org/v1/endpoint"
        ),
        arrayOf(
          "https://cdn3.wave.org/v1/endpoint",
          "https://***.org/***"
        ),
        arrayOf(
