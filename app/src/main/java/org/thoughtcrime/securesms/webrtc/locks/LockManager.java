...
public class LockManager {
  ...
  public LockManager(Context context) {
    ...
    fullLock = pm.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "wave:full");
    partialLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "wave:partial");
    proximityLock = new ProximityLock(pm);

    WifiManager wm = (WifiManager) context.getSystemService(Context.WIFI_SERVICE);
    wifiLock = wm.createWifiLock(WifiManager.WIFI_MODE_FULL_HIGH_PERF, "wave:wifi");
