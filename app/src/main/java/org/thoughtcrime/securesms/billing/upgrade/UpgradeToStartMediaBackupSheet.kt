...
private fun UpgradeToStartMediaBackupSheetContent(
  ...
  Column(
    ...
    Image(
      painter = painterResource(R.drawable.image_wave_backups_media),
    ...
    Text(
      text = pluralStringResource(R.plurals.UpgradeToStartMediaBackupSheet__your_current_wave_backup_plan_includes, freeBackupType.mediaRetentionDays, freeBackupType.mediaRetentionDays),
      textAlign = TextAlign.Center,
