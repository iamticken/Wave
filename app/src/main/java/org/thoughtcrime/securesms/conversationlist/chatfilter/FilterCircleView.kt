...
class FilterCircleView @JvmOverloads constructor(
  ...
  private val circleBackgroundColor = ContextCompat.getColor(context, R.color.wave_colorSurface1)
  private val strokeColor = ContextCompat.getColor(context, R.color.wave_colorSecondary)
  private val circleActiveBackgroundColor = ContextCompat.getColor(context, R.color.wave_colorSecondaryContainer)
  private val strokeActiveColor = ContextCompat.getColor(context, R.color.wave_colorPrimary)
