    ...
    if (savedInstanceState == null) {
      ...
      navGraph.setStartDestination(
        when (inAppPaymentType) {
          ...
          InAppPaymentType.ONE_TIME_DONATION, InAppPaymentType.RECURRING_DONATION -> R.id.donateToWaveFragment
      ...
      val startBundle = when (inAppPaymentType) {
        ...
        InAppPaymentType.ONE_TIME_DONATION, InAppPaymentType.RECURRING_DONATION -> DonateToWaveFragmentArgs.Builder(inAppPaymentType).build().toBundle()
      }
