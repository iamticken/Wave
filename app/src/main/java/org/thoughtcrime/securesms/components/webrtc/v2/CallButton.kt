  ...
  IconButtons.IconToggleButton(
    ...
    colors = IconButtons.run {
      iconToggleButtonColors(
        ...
        checkedContentColor = colorResource(id = R.color.wave_light_colorOnPrimary),
        containerColor = colorResource(id = R.color.wave_light_colorSecondaryContainer),
        contentColor = colorResource(id = R.color.wave_light_colorOnSecondaryContainer)
      )
    }
  ) {
    Icon(
...
private fun CallButton(
  ...
  contentColor: Color = colorResource(id = R.color.wave_light_colorOnPrimary),
...
fun StartCallButton(
  ...
  Buttons.LargePrimary(
    ...
    colors = ButtonDefaults.buttonColors(
      containerColor = colorResource(id = R.color.wave_light_colorPrimary),
      contentColor = colorResource(id = R.color.wave_light_colorOnPrimary)
    ),
