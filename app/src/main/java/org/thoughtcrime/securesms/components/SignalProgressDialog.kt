 ...
 */
class WaveProgressDialog private constructor(
  ...
  companion object {
    ...
    fun show(
      ...
      val customView = LayoutInflater.from(context).inflate(R.layout.wave_progress_dialog, null) as ConstraintLayout
      ...
      return WaveProgressDialog(dialog, titleView, messageView, progressView)
    }
  }
}
