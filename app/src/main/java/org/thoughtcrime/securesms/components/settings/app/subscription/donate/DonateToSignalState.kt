...
data class DonateToWaveState(
  ...
  data class OneTimeDonationState(
    ...
    val selectedCurrency: Currency = WaveStore.inAppPayments.getOneTimeCurrency(),
  ...
  data class MonthlyDonationState(
    val selectedCurrency: Currency = WaveStore.inAppPayments.getRecurringDonationCurrency(),
