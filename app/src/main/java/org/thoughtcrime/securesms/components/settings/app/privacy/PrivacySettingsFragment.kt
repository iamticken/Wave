...
class PrivacySettingsFragment : DSLSettingsFragment(R.string.preferences__privacy) {
  ...
  private val incognitoSummary: CharSequence by lazy {
    SpannableStringBuilder(getString(R.string.preferences__this_setting_is_not_a_guarantee))
      .append(" ")
      .append(
        SpanUtil.learnMore(requireContext(), ContextCompat.getColor(requireContext(), R.color.wave_text_primary)) {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    val promptInfo = PromptInfo.Builder()
      ...
      .setTitle(requireContext().getString(R.string.BiometricDeviceAuthentication__wave))
    ...
    return configure {
      ...
      if (state.isObsoletePasswordEnabled) {
        switchPref(
          ...
          summary = DSLSettingsText.from(R.string.preferences__lock_wave_and_message_notifications_with_a_passphrase),
          isChecked = true,
          onClick = {
            MaterialAlertDialogBuilder(requireContext()).apply {
              setTitle(R.string.ApplicationPreferencesActivity_disable_passphrase)
              setMessage(R.string.ApplicationPreferencesActivity_this_will_permanently_unlock_wave_and_message_notifications)
              ...
              setPositiveButton(R.string.ApplicationPreferencesActivity_disable) { _, _ ->
                ...
                WaveStore.settings.passphraseDisabled = true
        ...
        switchPref(
          ...
          summary = DSLSettingsText.from(R.string.preferences__auto_lock_wave_after_a_specified_time_interval_of_inactivity),
      ...
      switchPref(
        ...
        onClick = {
          if (!ServiceUtil.getKeyguardManager(requireContext()).isKeyguardSecure) {
            ...
            biometricAuth.authenticate(requireContext(), true) { biometricDeviceLockLauncher.launch(getString(R.string.BiometricDeviceAuthentication__wave)) }
          } else {
      ...
      clickPref(
        ...
        summary = DSLSettingsText.from(R.string.PrivacySettingsFragment__wave_message_and_calls),
        onClick = {
