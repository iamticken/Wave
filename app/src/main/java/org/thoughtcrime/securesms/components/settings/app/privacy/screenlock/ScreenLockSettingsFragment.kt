...
class ScreenLockSettingsFragment : ComposeFragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    enableLockPromptInfo = BiometricPrompt.PromptInfo.Builder()
      ...
      .setTitle(requireContext().getString(R.string.ScreenLockSettingsFragment__use_wave_screen_lock))
      .setConfirmationRequired(true)
      .build()

    disableLockPromptInfo = BiometricPrompt.PromptInfo.Builder()
      .setAllowedAuthenticators(BiometricDeviceAuthentication.ALLOWED_AUTHENTICATORS)
      .setTitle(requireContext().getString(R.string.ScreenLockSettingsFragment__turn_off_wave_lock))
      .setConfirmationRequired(true)
      .build()
        ...
        onChecked = { checked ->
          if (biometricAuth.canAuthenticate(requireContext()) && !checked) {
            ...
            biometricAuth.authenticate(requireContext(), true) {
              biometricDeviceLockLauncher.launch(getString(R.string.ScreenLockSettingsFragment__turn_off_wave_lock))
            }
