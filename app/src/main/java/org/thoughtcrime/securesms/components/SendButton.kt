...
class SendButton(context: Context, attributeSet: AttributeSet?) : AppCompatImageButton(context, attributeSet), OnLongClickListener {
  ...
  init {
    ...
    setImageResource(MessageSendType.WaveMessageSendType.buttonDrawableRes)
    contentDescription = context.getString(MessageSendType.WaveMessageSendType.titleRes)
  }
