...
class UsernameLinkSettingsFragment : ComposeFragment() {
  ...
  private fun askCameraPermissions() {
    Permissions.with(this)
      ...
      .ifNecessary()
      .withPermanentDenialDialog(getString(R.string.CameraXFragment_wave_needs_camera_access_scan_qr_code), null, R.string.CameraXFragment_allow_access_camera, R.string.CameraXFragment_to_scan_qr_codes, parentFragmentManager)
      .onAnyDenied { Toast.makeText(requireContext(), R.string.CameraXFragment_wave_needs_camera_access_scan_qr_code, Toast.LENGTH_LONG).show() }
      .execute()
  }
}
...
private fun TabButton(label: String, active: Boolean, onClick: () -> Unit, modifier: Modifier = Modifier) {
  val colors = if (active) {
    ...
    ButtonDefaults.buttonColors(
      containerColor = WaveTheme.colors.colorSurface2,
  ...
  Previews.Preview {
    MainScreen(
      state = UsernameLinkSettingsState(
        ...
        usernameLinkState = UsernameLinkState.Present("https://wave.org"),
  ...
  try {
    ByteArrayOutputStream().use { byteArrayOutputStream ->
      ...
      val shareUri = BlobProvider.getInstance()
        ...
        .withFileName("WaveUsernameQr.png")
