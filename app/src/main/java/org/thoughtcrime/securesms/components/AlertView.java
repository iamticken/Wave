...
public class AlertView extends AppCompatImageView {
  ...
  public void setFailed() {
    ...
    setColorFilter(ContextCompat.getColor(getContext(), R.color.wave_colorError));
  ...
  public void setRateLimited() {
    setVisibility(View.VISIBLE);
    setColorFilter(ContextCompat.getColor(getContext(), R.color.wave_colorOnSurfaceVariant));
