...
class PromptBatterySaverDialogFragment : FixedRoundedCornerBottomSheetDialogFragment() {
  ...
  companion object {
    ...
    fun show(fragmentManager: FragmentManager) {
      if (fragmentManager.findFragmentByTag(BottomSheetUtil.STANDARD_BOTTOM_SHEET_FRAGMENT_TAG) == null) {
        ...
        WaveStore.uiHints.lastBatterySaverPrompt = System.currentTimeMillis()
      }
    }
  }
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    binding.message.setLinkColor(ContextCompat.getColor(requireContext(), R.color.wave_colorPrimary))
    ...
    binding.continueButton.setOnClickListener {
      ...
      LocalMetrics.clear()
      WaveStore.uiHints.markDismissedBatterySaverPrompt()
      dismiss()
    }
