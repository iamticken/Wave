...
class SafetyNumberQrView : ConstraintLayout {
  ...
  fun setSafetyNumberType(newType: Boolean) {
    if (newType) {
      ImageViewCompat.setImageTintList(shareButton, ColorStateList.valueOf(ContextCompat.getColor(context, R.color.wave_dark_colorOnSurface)))
      setBackgroundColor(ContextCompat.getColor(context, R.color.safety_number_card_blue))
      codes.forEach {
        it.setTextColor(ContextCompat.getColor(context, R.color.wave_light_colorOnPrimary))
      }
    } else {
      ImageViewCompat.setImageTintList(shareButton, ColorStateList.valueOf(ContextCompat.getColor(context, R.color.wave_light_colorOnSurface)))
      setBackgroundColor(ContextCompat.getColor(context, R.color.safety_number_card_grey))
      codes.forEach {
        it.setTextColor(ContextCompat.getColor(context, R.color.wave_light_colorOnSurfaceVariant))
      }
    }
  }
