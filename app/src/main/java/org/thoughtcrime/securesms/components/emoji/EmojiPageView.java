...
public class EmojiPageView extends RecyclerView implements VariationSelectorListener {
                         ...
                         @LayoutRes int displayEmoticonLayoutResId)
  {
    ...
    Drawable drawable = DrawableUtil.tint(ContextUtil.requireDrawable(getContext(), R.drawable.triangle_bottom_right_corner), ContextCompat.getColor(getContext(), R.color.wave_button_secondary_text_disabled));
