...
public class FromTextView extends SimpleEmojiTextView {
  ...
  private Drawable getMuted() {
    return getDrawable(R.drawable.ic_bell_disabled_16, R.color.wave_icon_tint_secondary);
  }

  private Drawable getPinned() {
    return getDrawable(R.drawable.symbol_pin_16, R.color.wave_colorOnSurface);
  }
