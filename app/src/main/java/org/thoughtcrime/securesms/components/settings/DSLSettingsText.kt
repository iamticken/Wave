...
sealed class DSLSettingsText {
  ...
  object TitleLargeModifier : TextAppearanceModifier(R.style.Wave_Text_TitleLarge)
  object TitleMediumModifier : TextAppearanceModifier(R.style.Wave_Text_TitleMedium)
  object BodyLargeModifier : TextAppearanceModifier(R.style.Wave_Text_BodyLarge)
