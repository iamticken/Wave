    ...
    LazyColumn(
      ...
      item {
        Rows.ToggleRow(
          ...
          label = stringResource(R.string.preferences_advanced__relay_all_calls_through_the_wave_server_to_avoid_revealing_your_ip_address),
      ...
      item {
        val censorshipSummaryResId: Int = when (state.censorshipCircumventionState) {
          CensorshipCircumventionState.AVAILABLE -> R.string.preferences_communication__censorship_circumvention_if_enabled_wave_will_attempt_to_circumvent_censorship
