...
import org.wave.core.ui.compose.Buttons
import org.wave.core.ui.compose.DayNightPreviews
import org.wave.core.ui.compose.Dialogs
import org.wave.core.ui.compose.Dividers
import org.wave.core.ui.compose.Previews
import org.wave.core.ui.compose.Rows
import org.wave.core.ui.compose.Scaffolds
import org.wave.core.ui.compose.Snackbars
import org.wave.core.ui.compose.Texts
import org.wave.core.ui.compose.horizontalGutters
...
class RemoteBackupsSettingsFragment : ComposeFragment() {
  ...
  override fun FragmentContent() {
    ...
    val deleteState by WaveStore.backup.deletionStateFlow.collectAsStateWithLifecycle(initialValue = WaveStore.backup.deletionState)
  ...
  private inner class Callbacks : ContentCallbacks {
    ...
    override fun onFreeTierBackupSizeLearnMore() {
      CommunicationActions.openBrowserLink(requireContext(), "https://support.wave.org/hc/articles/9708267671322")
    }
  }
      ...
      item {
        Column(
          modifier = Modifier
            ...
            .background(color = WaveTheme.colors.colorSurface2, shape = RoundedCornerShape(12.dp))
            .padding(24.dp)
        ) {
          Text(
...
private fun BackupCard(
  ...
  Column(
    ...
    Row(modifier = Modifier.fillMaxWidth()) {
      ...
      Image(
        painter = painterResource(R.drawable.image_wave_backups),
...
private fun CallToActionButton(
  ...
  Buttons.MediumTonal(
    ...
    colors = ButtonDefaults.filledTonalButtonColors().copy(
      containerColor = WaveTheme.colors.colorTransparent5,
      contentColor = colorResource(R.color.wave_light_colorOnSurface)
    ),
    modifier = Modifier.padding(top = 12.dp)
  ) {
    Text(
...
private fun RedemptionErrorAlert(
  ...
  Row(
    ...
    modifier = Modifier
      ...
      .border(
        width = 1.dp,
        color = colorResource(R.color.wave_colorOutline_38),
      ...
      Box {
        ...
        Box(
          modifier = Modifier
            ...
            .border(5.dp, color = WaveTheme.colors.colorSurface2, shape = CircleShape)
