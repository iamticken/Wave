...
class UnauthorizedBanner(val context: Context) : Banner<Unit>() {
  ...
  override val enabled: Boolean
    get() = TextSecurePreferences.isUnauthorizedReceived(context) || !WaveStore.account.isRegistered
...
private fun Banner(contentPadding: PaddingValues) {
  ...
  DefaultBanner(
    title = null,
    body = stringResource(id = R.string.UnauthorizedReminder_this_is_likely_because_you_registered_your_phone_number_with_Wave_on_a_different_device),
