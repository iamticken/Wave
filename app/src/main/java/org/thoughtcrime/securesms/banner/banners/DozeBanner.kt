...
class DozeBanner(private val context: Context, private val onDismissListener: () -> Unit) : Banner<Unit>() {
  ...
  override val enabled: Boolean
    get() = !WaveStore.account.fcmEnabled && !TextSecurePreferences.hasPromptedOptimizeDoze(context) && !ServiceUtil.getPowerManager(context).isIgnoringBatteryOptimizations(context.packageName)
