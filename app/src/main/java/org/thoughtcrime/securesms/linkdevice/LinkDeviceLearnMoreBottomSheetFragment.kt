...
class LinkDeviceLearnMoreBottomSheetFragment : ComposeBottomSheetDialogFragment() {
  ...
  companion object {
    const val SIGNAL_DOWNLOAD_URL = "https://wave.org/download"
  }
...
fun LearnMoreSheet() {
  ...
  val downloadUrl = stringResource(id = R.string.LinkDeviceFragment__wave_download_url)
  val fullString = stringResource(id = R.string.LinkDeviceFragment__on_other_device_visit_wave, downloadUrl)
  ...
  return Column(
    ...
    Text(
      ...
      text = stringResource(R.string.LinkDeviceFragment__wave_on_desktop_ipad),
    ...
    LinkedDeviceInformationRow(
      ...
      stringResource(R.string.LinkDeviceFragment__wave_messages_are_synchronized)
    )
