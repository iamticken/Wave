...
class ExpiringStoriesManager(
  ...
  private val mmsDatabase = WaveDatabase.messages
  ...
  override fun getNextClosestEvent(): Event? {
    val oldestTimestamp = mmsDatabase.getOldestStorySendTimestamp(WaveStore.story.userHasViewedOnboardingStory) ?: return null
  ...
  override fun executeEvent(event: Event) {
    ...
    val deletes = mmsDatabase.deleteStoriesOlderThan(threshold, WaveStore.story.userHasViewedOnboardingStory)
