...
/**
 * Wave implementation of the Android telecom [ConnectionService]. The system binds to this service
...
class AndroidCallConnectionService : ConnectionService() {
  ...
  override fun onCreateIncomingConnection(
    ...
    val connection = AndroidCallConnection(
      ...
      setInitializing()
      if (WaveStore.settings.messageNotificationsPrivacy.isDisplayContact && recipient.e164.isPresent) {
    ...
    AppDependencies.waveCallManager.setTelecomApproved(callId, recipientId)
  ...
  override fun onCreateIncomingConnectionFailed(
    ...
    AppDependencies.waveCallManager.dropCall(callId)
  }
