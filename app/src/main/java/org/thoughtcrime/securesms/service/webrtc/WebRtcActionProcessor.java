...
import org.wave.ringrtc.CallManager.RingUpdate;
...
import org.whispersystems.waveservice.api.messages.calls.BusyMessage;
 ...
 * <p>
 * Processing of the actions occur in by calls from {@link WaveCallManager} and
...
public abstract class WebRtcActionProcessor {
  ...
  protected final @NonNull WebRtcServiceState handleSendOffer(@NonNull WebRtcServiceState currentState, @NonNull CallMetadata callMetadata, @NonNull OfferMetadata offerMetadata, boolean broadcast) {
    ...
    WaveServiceCallMessage callMessage         = WaveServiceCallMessage.forOffer(offerMessage, destinationDeviceId);
                                                                  ...
                                                                  @NonNull ReceivedOfferMetadata receivedOfferMetadata)
  {
    ...
    NotificationProfile activeProfile = NotificationProfiles.getActiveProfile(WaveDatabase.notificationProfiles().getProfiles());
                                                                     ...
                                                                     @NonNull ReceivedOfferMetadata receivedOfferMetadata)
  {
    ...
    try {
      ...
      byte[] localIdentityKey  = WebRtcUtil.getPublicKeyBytes(WaveStore.account().getAciIdentityKey().getPublicKey().serialize());
                                                         ...
                                                         boolean broadcast)
  {
    ...
    Integer       destinationDeviceId    = broadcast ? null : callMetadata.getRemoteDevice();
    WaveServiceCallMessage callMessage = WaveServiceCallMessage.forAnswer(answerMessage, destinationDeviceId);
  ...
  protected final @NonNull WebRtcServiceState handleSendBusy(@NonNull WebRtcServiceState currentState, @NonNull CallMetadata callMetadata, boolean broadcast) {
    ...
    Integer                  destinationDeviceId = broadcast ? null : callMetadata.getRemoteDevice();
    WaveServiceCallMessage callMessage         = WaveServiceCallMessage.forBusy(busyMessage, destinationDeviceId);
                                                               ...
                                                               boolean broadcast)
  {
    ...
    Integer                  destinationDeviceId = broadcast ? null : callMetadata.getRemoteDevice();
    WaveServiceCallMessage callMessage         = WaveServiceCallMessage.forHangup(hangupMessage, destinationDeviceId);
  ...
  protected @NonNull WebRtcServiceState handleAudioDeviceChanged(@NonNull WebRtcServiceState currentState, @NonNull WaveAudioManager.AudioDevice activeDevice, @NonNull Set<WaveAudioManager.AudioDevice> availableDevices) {
  ...
  protected @NonNull WebRtcServiceState handleSetUserAudioDevice(@NonNull WebRtcServiceState currentState, @NonNull WaveAudioManager.ChosenAudioDeviceIdentifier userDevice) {
  ...
  protected final @NonNull WebRtcServiceState handleSendIceCandidates(@NonNull WebRtcServiceState currentState, @NonNull CallMetadata callMetadata, boolean broadcast, @NonNull List<byte[]> iceCandidates) {
    ...
    Integer                  destinationDeviceId = broadcast ? null : callMetadata.getRemoteDevice();
    WaveServiceCallMessage callMessage         = WaveServiceCallMessage.forIceUpdates(iceUpdateMessages, destinationDeviceId);
                                                                  ...
                                                                  @NonNull RingUpdate ringUpdate)
  {
    ...
    try {
      ...
      WaveDatabase.calls().insertOrUpdateGroupCallFromRingState(ringId,
