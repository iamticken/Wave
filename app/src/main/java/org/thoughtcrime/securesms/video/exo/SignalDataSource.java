 ...
 */
 ...
 public class WaveDataSource implements DataSource {
  ...
  public WaveDataSource(@NonNull DefaultDataSource defaultDataSource,
  ...
  public static final class Factory implements DataSource.Factory {
    ...
    @Override
    public @NonNull WaveDataSource createDataSource() {
      return new WaveDataSource(new DefaultDataSourceFactory(context, "GenericUserAgent", null).createDataSource(),
