 ...
 */
class EmojiSearchTable(context: Context, databaseHelper: WaveDatabase) : DatabaseTable(context, databaseHelper) {
  ...
  fun setSearchIndex(
    ...
    databaseHelper.waveReadableDatabase.withinTransaction { db ->
