...
import org.wave.core.util.DatabaseId
import org.wave.core.util.DatabaseSerializer
 ...
 */
class InAppPaymentTable(context: Context, databaseHelper: WaveDatabase) : DatabaseTable(context, databaseHelper) {
