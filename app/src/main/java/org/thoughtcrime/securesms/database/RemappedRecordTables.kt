 ...
 */
class RemappedRecordTables internal constructor(context: Context?, databaseHelper: WaveDatabase?) : DatabaseTable(context, databaseHelper) {
  ...
  private fun addMapping(table: String, mapping: Mapping) {
    ...
    databaseHelper.waveWritableDatabase.insert(table, null, values)
  }
