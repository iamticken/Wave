...
public final class ReactionsBottomSheetDialogFragment extends BottomSheetDialogFragment {
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    setStyle(DialogFragment.STYLE_NORMAL, R.style.Theme_Wave_BottomSheetDialog_Fixed_ReactWithAny);
  ...
  public @NonNull Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
    ...
    WindowUtil.setNavigationBarColor(requireContext(), dialog.getWindow(), ContextCompat.getColor(requireContext(), R.color.wave_colorSurface1));
