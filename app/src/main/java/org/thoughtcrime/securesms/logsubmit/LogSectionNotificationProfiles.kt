...
class LogSectionNotificationProfiles : LogSection {
  ...
  override fun getContent(context: Context): CharSequence {
    val profiles: List<NotificationProfile> = WaveDatabase.notificationProfiles.getProfiles()

    val output = StringBuilder()

    output.append("Manually enabled profile: ${WaveStore.notificationProfile.manuallyEnabledProfile}\n")
    output.append("Manually enabled until  : ${WaveStore.notificationProfile.manuallyEnabledUntil}\n")
    output.append("Manually disabled at    : ${WaveStore.notificationProfile.manuallyDisabledAt}\n")
