...
import org.wave.debuglogsviewer.DebugLogsViewer;
...
public class SubmitDebugLogActivity extends BaseActivity {
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    this.uncaughtButton = findViewById(R.id.debug_log_waveUncaughtException);
  ...
  private void onFilterLevel(View view, boolean isChecked) {
    view.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(this, (isChecked) ? R.color.transparent_black_25 : R.color.wave_background_secondary)));
    ...
    if (isUncaught) selectedLevels.add("\" WaveUncaughtException:\"");
  ...
  private void onFilterLevelClose() {
    ...
    verboseButton.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(this, R.color.wave_background_secondary)));
    debugButton.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(this, R.color.wave_background_secondary)));
    infoButton.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(this, R.color.wave_background_secondary)));
    warningButton.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(this, R.color.wave_background_secondary)));
    errorButton.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(this, R.color.wave_background_secondary)));
    uncaughtButton.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(this, R.color.wave_background_secondary)));
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (item.getItemId() == android.R.id.home) {
      ...
      intent.putExtra(Intent.EXTRA_TITLE, "wave-log-" + System.currentTimeMillis() + ".zip");
    ...
    AlertDialog.Builder builder = new MaterialAlertDialogBuilder(this)
        ...
        .setPositiveButton(R.string.SubmitDebugLogActivity_share, (d, w) -> {
          ShareCompat.IntentBuilder.from(this)
                                   .setText(url)
                                   .setType("text/plain")
                                   .setEmailTo(new String[] { "support@wave.org" })
                                   .startChooser();
        });
