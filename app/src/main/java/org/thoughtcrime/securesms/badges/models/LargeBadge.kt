...
data class LargeBadge(
  ...
  class ViewHolder(itemView: View) : MappingViewHolder<Model>(itemView) {
    ...
    override fun bind(model: Model) {
      ...
      name.text = context.getString(R.string.ViewBadgeBottomSheetDialogFragment__s_supports_wave, model.shortName)
      description.text = if (model.largeBadge.badge.isSubscription()) {
        context.getString(R.string.ViewBadgeBottomSheetDialogFragment__s_supports_wave_with_a_monthly, model.shortName)
      } else {
        context.getString(R.string.ViewBadgeBottomSheetDialogFragment__s_supports_wave_with_a_donation, model.shortName)
      }
