...
import org.wave.core.util.FontUtil;
...
import org.wave.imageeditor.core.ColorableRenderer;
import org.wave.imageeditor.core.ImageEditorView;
import org.wave.imageeditor.core.Renderer;
import org.wave.imageeditor.core.SelectableRenderer;
import org.wave.imageeditor.core.model.EditorElement;
import org.wave.imageeditor.core.model.EditorModel;
import org.wave.imageeditor.core.renderers.BezierDrawingRenderer;
import org.wave.imageeditor.core.renderers.FaceBlurRenderer;
import org.wave.imageeditor.core.renderers.MultiLineTextRenderer;
                                                                   ...
                                                                   TextEntryDialogFragment.Controller
{
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    @ColorInt int blackoutColor = ContextCompat.getColor(requireContext(), R.color.wave_colorBackground);
    if (editorModel == null) {
      switch (mode) {
        case AVATAR_EDIT:
    ...
    if (!WaveStore.tooltips().hasSeenBlurHudIconTooltip()) {
      imageEditorHud.showBlurHudTooltip();
      WaveStore.tooltips().markBlurHudIconTooltipSeen();
    }
