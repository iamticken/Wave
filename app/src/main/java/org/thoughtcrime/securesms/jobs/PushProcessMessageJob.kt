...
import org.whispersystems.waveservice.api.crypto.protos.CompleteMessage
...
import org.whispersystems.waveservice.api.crypto.protos.EnvelopeMetadata as EnvelopeMetadataProto
...
class PushProcessMessageJob private constructor(
  ...
  companion object {
    ...
    fun processOrDefer(messageProcessor: MessageContentProcessor, result: MessageDecryptor.Result.Success, localReceiveMetric: WaveLocalMetrics.MessageReceive): PushProcessMessageJob? {
