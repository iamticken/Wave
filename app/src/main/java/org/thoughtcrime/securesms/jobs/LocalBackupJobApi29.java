...
import org.wave.core.util.androidx.DocumentFileUtil;
import org.wave.core.util.androidx.DocumentFileUtil.OperationResult;
...
public final class LocalBackupJobApi29 extends BaseJob {
  ...
  public void onRun() throws IOException {
    ...
    try {
      ...
      String       fileName        = String.format("wave-%s.backup", timestamp);
      ...
      try {
        ...
        BackupEvent finishedEvent = FullBackupExporter.export(context,
                                                              ...
                                                              WaveDatabase.getBackupDatabase(),
                                                              temporaryFile,
                                                              backupPassword,
                                                              this::isCanceled);
