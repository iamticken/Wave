...
import org.whispersystems.waveservice.internal.push.exceptions.InAppPaymentReceiptCredentialError
  ...
  override fun onRun() {
    ...
    if (serviceResponse.applicationError.isPresent) {
      ...
      if (isCredentialValid(inAppPayment, receiptCredential)) {
        ...
        WaveDatabase.donationReceipts.addReceipt(inAppPaymentReceiptRecord)
