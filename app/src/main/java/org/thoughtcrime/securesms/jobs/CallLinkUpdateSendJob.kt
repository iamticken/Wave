...
class CallLinkUpdateSendJob private constructor(
  ...
  override fun onRun() {
    val callLink = WaveDatabase.callLinks.getCallLinkByRoomId(callLinkRoomId)
    ...
    AppDependencies.waveServiceMessageSender
      .sendSyncMessage(WaveServiceSyncMessage.forCallLinkUpdate(callLinkUpdate))
  }
