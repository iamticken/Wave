...
public class MultiDeviceVerifiedUpdateJob extends BaseJob {
  ...
  public void onRun() throws IOException, UntrustedIdentityException {
    ...
    try {
      ...
      WaveServiceAddress          verifiedAddress = RecipientUtil.toWaveServiceAddress(context, recipient);
      ...
      messageSender.sendSyncMessage(WaveServiceSyncMessage.forVerified(verifiedMessage)
      );
