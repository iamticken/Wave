...
import org.whispersystems.waveservice.api.messages.WaveServiceTypingMessage.Action;
...
public class TypingSendJob extends BaseJob {
  ...
  public void onRun() throws Exception {
    ...
    if (!recipient.isRegistered()) {
      Log.w(TAG, "Not sending typing indicators to non-Wave recipients.");
      return;
    }
    ...
    WaveServiceTypingMessage typingMessage = new WaveServiceTypingMessage(typing ? Action.STARTED : Action.STOPPED, System.currentTimeMillis(), groupId);
