...
import org.whispersystems.waveservice.api.crypto.AttachmentCipherInputStream.StreamSupplier
...
class RestoreLocalAttachmentJob private constructor(
  ...
  companion object {
    ...
    fun enqueueRestoreLocalAttachmentsJobs(mediaNameToFileInfo: Map<String, DocumentFileInfo>) {
      ...
      do {
        val possibleRestorableAttachments: List<RestorableAttachment> = WaveDatabase.attachments.getRestorableAttachments(500)
        ...
        WaveDatabase.attachments.setRestoreTransferState(notRestorableAttachments, AttachmentTable.TRANSFER_PROGRESS_FAILED)
