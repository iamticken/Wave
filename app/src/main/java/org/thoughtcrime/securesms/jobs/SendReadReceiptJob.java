...
public class SendReadReceiptJob extends BaseJob {
  ...
  public void onRun() throws IOException, UntrustedIdentityException, UndeliverableMessageException {
    ...
    WaveServiceReceiptMessage receiptMessage = new WaveServiceReceiptMessage(WaveServiceReceiptMessage.Type.READ, messageSentTimestamps, timestamp);
    ...
    if (Util.hasItems(messageIds)) {
      WaveDatabase.messageLog().insertIfPossible(recipientId, timestamp, result, ContentHint.IMPLICIT, messageIds, false);
    }
  }
