...
import org.wave.core.util.OVERRIDE_TRANSITION_CLOSE_COMPAT
...
import org.wave.core.util.overrideActivityTransitionCompat
...
class MediaSelectionActivity :
  ...
  private fun animateTextStyling(selectedSwitch: TextView, unselectedSwitch: TextView, duration: Long) {
    val offTextColor = ContextCompat.getColor(this, R.color.wave_colorOnSurface)
    val onTextColor = ContextCompat.getColor(this, R.color.wave_colorSecondaryContainer)
  ...
  companion object {
    ...
    private fun buildIntent(
      context: Context,
      startAction: Int = -1,
      messageSendType: MessageSendType = MessageSendType.WaveMessageSendType,
