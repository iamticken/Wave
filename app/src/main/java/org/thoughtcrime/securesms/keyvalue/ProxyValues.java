...
public final class ProxyValues extends WaveStoreValues {
  ...
  public void enableProxy(@NonNull WaveProxy proxy) {
   ...
   */
  public void setProxy(@Nullable WaveProxy proxy) {
    if (proxy != null) {
      getStore().beginWrite()
                .putString(KEY_HOST, proxy.getHost())
                .putInteger(KEY_PORT, proxy.getPort())
