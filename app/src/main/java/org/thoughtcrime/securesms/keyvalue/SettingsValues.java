...
public final class SettingsValues extends WaveStoreValues {
  ...
  private static final String SIGNAL_BACKUP_DIRECTORY        = "settings.wave.backup.directory";
  private static final String SIGNAL_LATEST_BACKUP_DIRECTORY = "settings.wave.backup.directory,latest";
  private static final String CALL_DATA_MODE                 = "settings.wave.call.bandwidth.mode";
  ...
  public static final  String SIGNAL_BACKUPS_SCHEDULE_HOUR            = "settings.wave.backups.schedule.hour";
  public static final  String SIGNAL_BACKUPS_SCHEDULE_MINUTE          = "settings.wave.backups.schedule.minute";
  ...
  public static final  String NOTIFY_WHEN_CONTACT_JOINS_SIGNAL        = "settings.notify.when.contact.joins.wave";
  ...
  public void setWaveBackupDirectory(@NonNull Uri uri) {
  ...
  public @Nullable Uri getWaveBackupDirectory() {
    return getUri(SIGNAL_BACKUP_DIRECTORY);
  }

  public @Nullable Uri getLatestWaveBackupDirectory() {
    return getUri(SIGNAL_LATEST_BACKUP_DIRECTORY);
  }

  public void clearWaveBackupDirectory() {
  ...
  public int getWaveBackupMinute() {
  ...
  private void initWaveBackupsSchedule() {
    setWaveBackupSchedule(new Random().nextInt(5) + 1, new Random().nextInt(12) * 5);
  }

  public void setWaveBackupSchedule(int hour, int minute) {
  ...
  public boolean isNotifyWhenContactJoinsWave() {
  ...
  public void setNotifyWhenContactJoinsWave(boolean notifyWhenContactJoinsWave) {
    putBoolean(NOTIFY_WHEN_CONTACT_JOINS_SIGNAL, notifyWhenContactJoinsWave);
  }
