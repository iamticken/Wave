...
class MiscellaneousValues internal constructor(store: KeyValueStore) : WaveStoreValues(store) {
  companion object {
   ...
   *
   * estimatedServerTime = System.currentTimeMillis() - WaveStore.misc.getLastKnownServerTimeOffset()
   */
