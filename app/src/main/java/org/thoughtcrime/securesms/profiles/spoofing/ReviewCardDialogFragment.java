...
public class ReviewCardDialogFragment extends FullScreenDialogFragment {
  ...
  private final class AdapterCallbacks implements ReviewCardAdapter.Callbacks {
    ...
    @Override
    public void onWaveConnectionClicked() {
      new WaveConnectionsBottomSheetDialogFragment().show(getParentFragmentManager(), BottomSheetUtil.STANDARD_BOTTOM_SHEET_FRAGMENT_TAG);
    }
  }
}
