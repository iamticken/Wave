...
class EditProfileViewModel extends ViewModel {
  ...
  public boolean isRegisteredAndUpToDate() {
    return !TextSecurePreferences.isUnauthorizedReceived(AppDependencies.getApplication()) && WaveStore.account().isRegistered() && !WaveStore.misc().isClientDeprecated();
  }

  public boolean isDeprecated() {
    return WaveStore.misc().isClientDeprecated();
  }
  ...
  private void onRecipientChanged(@NonNull Recipient recipient) {
    ...
    username.postValue(WaveStore.account().getUsername());
