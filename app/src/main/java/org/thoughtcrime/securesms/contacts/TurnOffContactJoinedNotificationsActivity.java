...
/**
 * Activity which displays a dialog to confirm whether to turn off "Contact Joined Wave" notifications.
 */
public class TurnOffContactJoinedNotificationsActivity extends AppCompatActivity {
  ...
  protected void onResume() {
    ...
    new MaterialAlertDialogBuilder(this)
        .setMessage(R.string.TurnOffContactJoinedNotificationsActivity__turn_off_contact_joined_wave)
  ...
  private void handlePositiveAction(@NonNull DialogInterface dialog) {
    SimpleTask.run(getLifecycle(), () -> {
      ...
      WaveStore.settings().setNotifyWhenContactJoinsWave(false);
