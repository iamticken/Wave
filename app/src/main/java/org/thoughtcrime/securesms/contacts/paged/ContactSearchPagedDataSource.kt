...
class ContactSearchPagedDataSource(
  ...
  override fun load(start: Int, length: Int, totalSize: Int, cancellationWave: PagedDataSource.CancellationWave): MutableList<ContactSearchData> {
  ...
  private fun getNonGroupSearchIterator(section: ContactSearchConfiguration.Section.Individuals, query: String?): ContactSearchIterator<Cursor> {
    ...
    return CursorSearchIterator(wrapRecipientCursor(contactSearchPagedDataSourceRepository.queryWaveContacts(searchQuery)))
  }
  ...
  private fun getNonGroupHeaderLetterMap(section: ContactSearchConfiguration.Section.Individuals, query: String?): Map<RecipientId, String> {
    return contactSearchPagedDataSourceRepository.queryWaveContactLetterHeaders(
      query = query,
