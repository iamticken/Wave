...
fun AvailableStickerPackRow(
  ...
  Row(
    ...
    DropdownMenus.Menu(
      ...
      offsetX = 0.dp,
      offsetY = 12.dp,
      modifier = modifier.background(WaveTheme.colors.colorSurface2)
    ) {
      MenuItem(
...
fun InstalledStickerPackRow(
  ...
  Row(
    ...
    modifier = modifier
      .padding(horizontal = 16.dp)
      .background(
        color = if (selected) WaveTheme.colors.colorSurface2 else MaterialTheme.colorScheme.surface,
        shape = RoundedCornerShape(18.dp)
      )
