...
public class AccountManagerFactory {
   ...
   */
  public @NonNull WaveServiceAccountManager createUnauthenticated(@NonNull Context context,
                                                                    @NonNull String e164,
                                                                    int deviceId,
                                                                    @NonNull String password)
  {
    if (new WaveServiceNetworkAccess(context).isCensored(e164)) {
    ...
    return WaveServiceAccountManager.createWithStaticCredentials(
        AppDependencies.getWaveServiceNetworkAccess().getConfiguration(e164),
        null,
        null,
        e164,
        deviceId,
