...
public class StorageUtil {
  ...
  public static File getBackupDirectory() throws NoExternalStorageException {
    File storage = Environment.getExternalStorageDirectory();
    File wave  = new File(storage, "Wave");
    File backups = new File(wave, "Backups");
  ...
  public static File getBackupV2Directory() throws NoExternalStorageException {
    File storage = Environment.getExternalStorageDirectory();
    File backups  = new File(storage, "Wave");
  ...
  private static File getWaveStorageDir() throws NoExternalStorageException {
  ...
  public static boolean canWriteInWaveStorageDir() {
    File storage;

    try {
      storage = getWaveStorageDir();
