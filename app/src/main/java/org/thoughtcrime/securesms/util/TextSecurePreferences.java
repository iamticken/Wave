...
public class TextSecurePreferences {
  ...
  public static void onPostBackupRestore(@NonNull Context context) {
    if (NotificationChannels.supported()) {
      NotificationChannels.getInstance().updateMessageVibrate(WaveStore.settings().isMessageVibrateEnabled());
    }
  }
  ...
  /**
   * @deprecated Use {@link SettingsValues#getMessageFontSize()} via {@link org.thoughtcrime.securesms.keyvalue.WaveStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#getTheme()} via {@link org.thoughtcrime.securesms.keyvalue.WaveStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#getLanguage()} via {@link org.thoughtcrime.securesms.keyvalue.WaveStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#setLanguage(String)} via {@link org.thoughtcrime.securesms.keyvalue.WaveStore} instead.
   */
  @Deprecated
  ...
  private static void clearLocalCredentials(Context context) {
    ...
    WaveDatabase.recipients().setProfileKey(self.getId(), newProfileKey);
  ...
  private static void notifyUnregisteredReceived(Context context) {
    ...
    final NotificationCompat.Builder builder = new NotificationCompat.Builder(context, NotificationChannels.getInstance().FAILURES)
        .setSmallIcon(R.drawable.ic_wave_logo_large)
