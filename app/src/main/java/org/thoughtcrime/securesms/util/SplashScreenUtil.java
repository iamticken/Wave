...
public final class SplashScreenUtil {
  ...
  public static void setSplashScreenThemeIfNecessary(@Nullable Activity activity, @NonNull SettingsValues.Theme theme) {
    ...
    switch (theme) {
      case LIGHT:
        activity.getSplashScreen().setSplashScreenTheme(R.style.Theme_Wave_DayNight_NoActionBar_LightSplash);
        break;
      case DARK:
        activity.getSplashScreen().setSplashScreenTheme(R.style.Theme_Wave_DayNight_NoActionBar_DarkSplash);
        break;
      case SYSTEM:
