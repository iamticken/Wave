...
import org.wave.core.util.ResourceUtil;
...
public final class SupportEmailUtil {
  ...
  private static @NonNull String buildSystemInfo(@NonNull Context context, @StringRes int filter, @NonNull String filterSuffix) {
    ...
    return "--- " + context.getString(R.string.HelpFragment__support_info) + " ---" +
           ...
           "\n" +
           context.getString(R.string.SupportEmailUtil_wave_version) + " " + getWaveVersion() +
           "\n" +
           context.getString(R.string.SupportEmailUtil_wave_package) + " " + getWavePackage(context) +
           "\n" +
  ...
  private static CharSequence getWaveVersion() {
    return BuildConfig.VERSION_NAME;
  }

  private static CharSequence getWavePackage(@NonNull Context context) {
  ...
  private static CharSequence getRegistrationLockEnabled() {
    return String.valueOf(WaveStore.svr().isRegistrationLockEnabled());
  }
}
