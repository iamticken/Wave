...
import org.thoughtcrime.securesms.conversation.WaveBottomActionBarController
...
class CallLogFragment : Fragment(R.layout.call_log_fragment), CallLogAdapter.Callbacks, CallLogContextMenu.Callbacks {
  ...
  private lateinit var waveBottomActionBarController: WaveBottomActionBarController
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    waveBottomActionBarController = WaveBottomActionBarController(
    ...
    binding.pullView.onFilterStateChanged = OnFilterStateChanged { state: FilterPullState?, source: ConversationFilterSource ->
      when (state) {
        ...
        FilterPullState.OPEN_APEX -> if (source === ConversationFilterSource.DRAG) {
          // TODO[alex] -- hint here? WaveStore.uiHints.incrementNeverDisplayPullToFilterTip()
        }
  ...
  private inner class BottomActionBarControllerCallback : WaveBottomActionBarController.Callback {
  ...
  inner class CallLogActionModeCallback : CallLogActionMode.Callback {
    override fun startActionMode() {
      ...
      waveBottomActionBarController.setVisibility(true)
    }

    override fun onActionModeWillEnd() {
      requireListener<Callback>().onMultiSelectFinished()
      waveBottomActionBarController.setVisibility(false)
