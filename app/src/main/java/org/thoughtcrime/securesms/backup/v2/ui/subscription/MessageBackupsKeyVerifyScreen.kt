  ...
  Scaffolds.Settings(
    ...
    if (sheetState.isVisible) {
      ModalBottomSheet(
        ...
        dragHandle = null,
        containerColor = WaveTheme.colors.colorSurface1,
        onDismissRequest = {
...
private fun BottomSheetContent(
  ...
  LazyColumn(
    ...
    item {
      Image(
        painter = painterResource(R.drawable.image_wave_backups_key),
    ...
    item {
      Text(
        text = stringResource(R.string.MessageBackupsKeyRecordScreen__wave_will_not),
