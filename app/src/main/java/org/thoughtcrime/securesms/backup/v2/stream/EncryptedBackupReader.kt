...
import org.wave.core.util.readVarInt32
import org.wave.core.util.stream.LimitedInputStream
import org.wave.core.util.stream.MacInputStream
...
class EncryptedBackupReader private constructor(
  ...
  companion object {
    ...
    /**
     * Create a reader for a local backup or for a transfer to a linked device. Basically everything that isn't [createForWaveBackup].
