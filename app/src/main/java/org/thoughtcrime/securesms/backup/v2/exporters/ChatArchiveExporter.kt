...
class ChatArchiveExporter(private val cursor: Cursor, private val db: WaveDatabase, private val exportState: ExportState, private val includeImageWallpapers: Boolean) : Iterator<Chat>, Closeable {
