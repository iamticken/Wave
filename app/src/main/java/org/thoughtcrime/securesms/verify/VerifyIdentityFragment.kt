...
import org.wave.qr.kitkat.ScanListener
...
class VerifyIdentityFragment : Fragment(R.layout.fragment_container), ScanListener, VerifyDisplayFragment.Callback {
  ...
  private val displayFragment by lazy {
    VerifyDisplayFragment.create(
      recipientId,
      remoteIdentity,
      IdentityKeyParcelable(WaveStore.account.aciIdentityKey.publicKey),
  ...
  override fun onQrCodeContainerClicked() {
    Permissions.with(this)
      ...
      .withPermanentDenialDialog(getString(R.string.VerifyIdentityActivity_wave_needs_the_camera_permission_in_order_to_scan_a_qr_code_but_it_has_been_permanently_denied), null, R.string.CameraXFragment_allow_access_camera, R.string.CameraXFragment_to_scan_qr_codes, getParentFragmentManager())
      .onAllGranted {
        childFragmentManager.beginTransaction()
