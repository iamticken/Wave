...
public final class OldDeviceTransferSetupFragment extends DeviceTransferSetupFragment {
  ...
  protected void startTransfer() {
    ...
    DeviceToDeviceTransferService.TransferNotificationData notificationData = new DeviceToDeviceTransferService.TransferNotificationData(NotificationIds.DEVICE_TRANSFER, NotificationChannels.getInstance().BACKUPS, R.drawable.ic_wave_backup);
  ...
  protected @StringRes int getErrorTextForStep(@NonNull SetupStep step) {
    switch (step) {
      case PERMISSIONS_DENIED:
        return R.string.OldDeviceTransferSetup__wave_needs_the_location_permission_to_discover_and_connect_with_your_new_device;
      case LOCATION_DISABLED:
        return R.string.OldDeviceTransferSetup__wave_needs_location_services_enabled_to_discover_and_connect_with_your_new_device;
      case WIFI_DISABLED:
        return R.string.OldDeviceTransferSetup__wave_needs_wifi_on_to_discover_and_connect_with_your_new_device;
