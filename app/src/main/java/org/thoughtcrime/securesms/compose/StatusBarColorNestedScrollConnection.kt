...
class StatusBarColorNestedScrollConnection(
  ...
  private val normalColor = ContextCompat.getColor(activity, R.color.wave_colorBackground)
  private val scrollColor = ContextCompat.getColor(activity, R.color.wave_colorSurface2)
