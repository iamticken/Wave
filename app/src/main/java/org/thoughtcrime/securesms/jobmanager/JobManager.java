...
public class JobManager implements ConstraintObserver.Notifier {
  ...
  public JobManager(@NonNull Application application, @NonNull Configuration configuration) {
    ...
    this.executor      = new FilteredExecutor(configuration.getExecutorFactory().newSingleThreadExecutor("wave-JobManager"), () -> {
      return ThreadUtil.isMainThread() || Thread.currentThread().getName().equals("Instr: org.thoughtcrime.securesms.testing.WaveTestRunner");
    });
