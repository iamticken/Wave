...
import org.whispersystems.waveservice.api.crypto.protos.EnvelopeMetadata
import org.whispersystems.waveservice.internal.push.Envelope
import org.whispersystems.waveservice.internal.serialize.protos.WaveServiceContentProto
...
class PushProcessMessageJobMigration : JobMigration(10) {
  ...
  companion object {
    ...
    private fun migratePushProcessJobWithDecryptedData(jobData: JobData, inputData: JsonJobData): JobData {
      ...
      val proto = WaveServiceContentProto.ADAPTER.decode(protoBytes)
