...
class GroupStorySettingsFragment : DSLSettingsFragment(menuId = R.menu.story_group_menu) {
  ...
  override fun onOptionsItemSelected(item: MenuItem): Boolean {
    ...
    if (item.itemId == R.id.action_overflow) {
      WaveContextMenu.Builder(toolbar, requireView() as ViewGroup)
    ...
    return configure {
      ...
      textPref(
        title = DSLSettingsText.from(
          ...
          DSLSettingsText.TextAppearanceModifier(R.style.Wave_Text_BodyMedium),
          DSLSettingsText.ColorModifier(ContextCompat.getColor(requireContext(), R.color.wave_colorOnSurfaceVariant))
        )
      )
      ...
      clickPref(
        title = DSLSettingsText.from(
          ...
          DSLSettingsText.ColorModifier(ContextCompat.getColor(requireContext(), R.color.wave_colorError))
        ),
        onClick = {
