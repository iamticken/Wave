...
import org.thoughtcrime.securesms.databinding.ViewAllWaveConnectionsFragmentBinding
import org.thoughtcrime.securesms.groups.SelectionLimits

class ViewAllWaveConnectionsFragment : Fragment(R.layout.view_all_wave_connections_fragment) {

  private val binding by ViewBinderDelegate(ViewAllWaveConnectionsFragmentBinding::bind)
  ...
  class Dialog : WrapperDialogFragment() {
    override fun getWrappedFragment(): Fragment {
      return ViewAllWaveConnectionsFragment()
    }
