...
public final class Wallet {
  ...
  public @NonNull Balance getCachedBalance() {
    return WaveStore.payments().mobileCoinLatestBalance();
  }

  @AnyThread
  public @NonNull MobileCoinLedgerWrapper getCachedLedger() {
    return WaveStore.payments().mobileCoinLatestFullLedger();
  }
    ...
    try {
      ...
      builder.spentTxos(spentTxos)
             ...
             .highestBlock(new MobileCoinLedger.Block.Builder()
                                                     ...
                                                     .build());
      WaveStore.payments().setEnclaveFailure(false);
      ...
      WaveStore.payments().setEnclaveFailure(true);
