...
public class PaymentsRecoveryPhraseConfirmFragment extends Fragment {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    DrawableCompat.setTint(validWordCheckMark, ContextCompat.getColor(requireContext(), R.color.wave_accent_green));
    DrawableCompat.setTint(invalidWordX, ContextCompat.getColor(requireContext(), R.color.wave_alert_primary));
    ...
    seePhraseAgain.setOnClickListener(v -> Navigation.findNavController(requireView()).popBackStack());
      ...
      WaveStore.payments().confirmMnemonic(true);
