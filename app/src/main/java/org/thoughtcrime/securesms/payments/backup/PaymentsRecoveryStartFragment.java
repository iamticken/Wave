  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    if (args.getIsRestore()) {
      ...
      startButton.setOnClickListener(v -> {
        if (state == RecoveryPhraseStates.FROM_PAYMENTS_MENU_WITH_MNEMONIC_CONFIRMED && ServiceUtil.getKeyguardManager(requireContext()).isKeyguardSecure() && WaveStore.payments().isPaymentLockEnabled()) {
