...
internal class SubscriberIdMigrationJob(
  ...
  override fun performMigration() {
    Currency.getAvailableCurrencies().forEach { currency ->
      val subscriber = WaveStore.inAppPayments.getSubscriber(currency)
      ...
      if (subscriber != null) {
        WaveDatabase.inAppPaymentSubscribers.insertOrReplace(
          InAppPaymentSubscriberRecord(
            ...
            requiresCancel = WaveStore.inAppPayments.shouldCancelSubscriptionBeforeNextSubscribeAttempt,
            paymentMethodType = WaveStore.inAppPayments.getSubscriptionPaymentSourceType().toPaymentMethodType(),
