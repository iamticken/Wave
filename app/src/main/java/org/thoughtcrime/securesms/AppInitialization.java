...
public final class AppInitialization {
  ...
  public static void onFirstEverAppLaunch(@NonNull Context context) {
    ...
    WaveStore.onFirstEverAppLaunch();
  ...
  public static void onPostBackupRestore(@NonNull Context context) {
    ...
    AppDependencies.getMegaphoneRepository().onFirstEverAppLaunch();
    WaveStore.onPostBackupRestore();
    WaveStore.onFirstEverAppLaunch();
    WaveStore.onboarding().clearAll();
    WaveStore.settings().setPassphraseDisabled(true);
    WaveStore.notificationProfile().setHasSeenTooltip(true);
    ...
    if (WaveStore.misc().startedQuoteThumbnailMigration()) {
