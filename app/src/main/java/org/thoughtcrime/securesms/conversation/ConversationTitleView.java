...
public class ConversationTitleView extends ConstraintLayout {
  ...
  public void setTitle(@NonNull RequestManager requestManager, @Nullable Recipient recipient) {
    ...
    if (startDrawable != null) {
      startDrawable = DrawableUtil.tint(startDrawable, ContextCompat.getColor(getContext(), R.color.wave_inverse_transparent_80));
    }

    if (endDrawable != null) {
      endDrawable = DrawableUtil.tint(endDrawable, ContextCompat.getColor(getContext(), R.color.wave_inverse_transparent_80));
    }
