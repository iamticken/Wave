...
class Colorizer {
  ...
  fun getIncomingBodyTextColor(context: Context, hasWallpaper: Boolean): Int {
    return if (hasWallpaper) {
      ContextCompat.getColor(context, R.color.wave_colorNeutralInverse)
    } else {
      ContextCompat.getColor(context, R.color.wave_colorOnSurface)
    }
  }
  ...
  fun getIncomingFooterTextColor(context: Context, hasWallpaper: Boolean): Int {
    return if (hasWallpaper) {
      ContextCompat.getColor(context, R.color.wave_colorNeutralVariantInverse)
    } else {
      ContextCompat.getColor(context, R.color.wave_colorOnSurfaceVariant)
    }
  }
