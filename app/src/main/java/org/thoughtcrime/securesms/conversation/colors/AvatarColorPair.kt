    ...
    fun create(context: Context, avatarColor: AvatarColor): AvatarColorPair {
      return when (avatarColor) {
        AvatarColor.UNKNOWN -> AvatarColorPair(
          foregroundColor = ContextCompat.getColor(context, R.color.wave_colorOnSurface),
          backgroundColor = ContextCompat.getColor(context, R.color.wave_colorSurfaceVariant)
        )
        AvatarColor.ON_SURFACE_VARIANT -> AvatarColorPair(
          foregroundColor = ContextCompat.getColor(context, R.color.wave_colorOnSurfaceVariant),
          backgroundColor = ContextCompat.getColor(context, R.color.wave_colorSurfaceVariant)
        )
