...
class CustomChatColorGradientToolView @JvmOverloads constructor(
  ...
  private val backgroundPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
    color = ContextCompat.getColor(context, R.color.wave_background_primary)
  }

  private val thumbBorderPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
    color = ContextCompat.getColor(context, R.color.wave_inverse_transparent_10)
  }

  private val thumbBorderPaintSelected = Paint(Paint.ANTI_ALIAS_FLAG).apply {
    color = ContextCompat.getColor(context, R.color.wave_inverse_transparent_60)
  }
