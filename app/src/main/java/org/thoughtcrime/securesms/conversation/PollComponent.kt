  ...
  composeView.setContent {
    WaveTheme(
      ...
      Poll(
        ...
        fontSize = WaveStore.settings.messageFontSize
      )
    }
  }
}
  ...
  Row(
    modifier = Modifier
      ...
      .clickable(
        ...
        indication = null,
        onClickLabel = stringResource(R.string.WaveCheckbox_accessibility_on_click_label),
        enabled = true
      )
  ) {
    if (!hasEnded) {
          ...
          VoteState.PENDING_ADD -> {
            Box(modifier = Modifier) {
              ...
              Icon(
                ...
                contentDescription = stringResource(R.string.WaveCheckbox_accessibility_unchecked_description),
  ...
  data object Outgoing : PollColorsType {
    ...
    override fun getColors(chatColor: Int): PollColors {
      return PollColors(
        ...
        progressBackground = WaveTheme.colors.colorTransparent3,
  ...
  data object Incoming : PollColorsType {
    ...
    override fun getColors(chatColor: Int): PollColors {
      return PollColors(
        ...
        progressBackground = if (DynamicTheme.isDarkTheme(LocalContext.current)) WaveTheme.colors.colorTransparent2 else WaveTheme.colors.colorTransparentInverse3,
