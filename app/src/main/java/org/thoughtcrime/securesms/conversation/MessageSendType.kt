...
/**
 * The kinds of messages you can send, e.g. a plain Wave message, an SMS message, etc.
 */
@Parcelize
sealed class MessageSendType(
  ...
  @get:JvmName("usesWaveTransport")
  val usesWaveTransport
  ...
  /**
   * A type representing a basic Wave message.
   */
  @Parcelize
  object WaveMessageSendType : MessageSendType(
