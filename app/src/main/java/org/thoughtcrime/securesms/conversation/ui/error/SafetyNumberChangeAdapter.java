  ...
  class ViewHolder extends RecyclerView.ViewHolder {
    ...
    void bind(@NonNull ChangedRecipient changedRecipient) {
      ...
      if (changedRecipient.isUnverified() || changedRecipient.isVerified()) {
        ...
        Drawable check = DrawableUtil.tint(ContextUtil.requireDrawable(itemView.getContext(), R.drawable.symbol_check_24), ContextCompat.getColor(itemView.getContext(), R.color.wave_text_secondary));
