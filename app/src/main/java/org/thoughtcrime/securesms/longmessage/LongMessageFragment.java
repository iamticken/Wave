  ...
  private void initViewModel(long messageId, boolean isMms) {
    ...
    viewModel.getMessage().observe(this, message -> {
      ...
      if (message.get().getMessageRecord().isOutgoing()) {
        ...
        bubble.getBackground().setColorFilter(ContextCompat.getColor(requireContext(), R.color.wave_background_secondary), PorterDuff.Mode.MULTIPLY);
      }
      ...
      text.setTextSize(TypedValue.COMPLEX_UNIT_SP, WaveStore.settings().getMessageFontSize());
