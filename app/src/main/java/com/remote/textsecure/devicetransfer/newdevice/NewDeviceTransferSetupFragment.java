...
import org.wave.devicetransfer.DeviceToDeviceTransferService;
import org.wave.devicetransfer.DeviceToDeviceTransferService.TransferNotificationData;
...
public final class NewDeviceTransferSetupFragment extends DeviceTransferSetupFragment {
  ...
  protected @StringRes int getErrorTextForStep(@NonNull SetupStep step) {
    switch (step) {
      case PERMISSIONS_DENIED:
        return R.string.NewDeviceTransferSetup__wave_needs_the_location_permission_to_discover_and_connect_with_your_old_device;
      case LOCATION_DISABLED:
        return R.string.NewDeviceTransferSetup__wave_needs_location_services_enabled_to_discover_and_connect_with_your_old_device;
      case WIFI_DISABLED:
        return R.string.NewDeviceTransferSetup__wave_needs_wifi_on_to_discover_and_connect_with_your_old_device;
  ...
  protected void startTransfer() {
    ...
    TransferNotificationData notificationData = new TransferNotificationData(NotificationIds.DEVICE_TRANSFER, NotificationChannels.getInstance().BACKUPS, R.drawable.ic_wave_backup);
