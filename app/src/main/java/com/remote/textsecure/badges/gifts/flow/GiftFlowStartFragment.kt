    ...
    return configure {
      ...
      noPadTextPref(
        title = DSLSettingsText.from(
          ...
          DSLSettingsText.TextAppearanceModifier(R.style.Wave_Text_Headline)
        )
      )
      ...
      noPadTextPref(
        title = DSLSettingsText.from(resources.getQuantityString(R.plurals.GiftFlowStartFragment__support_wave_by, days.toInt(), days), DSLSettingsText.CenterModifier)
      )
