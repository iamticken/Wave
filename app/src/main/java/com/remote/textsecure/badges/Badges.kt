...
object Badges {
  ...
  private fun getBestBadgeImageUriForDevice(serviceBadge: WaveServiceProfile.Badge): Pair<Uri, String> {
  ...
  @JvmStatic
  fun fromServiceBadge(serviceBadge: WaveServiceProfile.Badge): Badge {
