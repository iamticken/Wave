...
import org.thoughtcrime.securesms.fonts.WaveSymbols.WaveSymbol
...
class TransferAccountActivity : PassphraseRequiredActivity() {
  ...
  companion object {
    ...
    const val LEARN_MORE_URL = "https://support.wave.org/hc/articles/360007059752-Backup-and-Restore-Messages"
    ...
    Column(
      ...
      Text(
        text = buildAnnotatedString {
          WaveSymbol(WaveSymbols.Weight.REGULAR, WaveSymbols.Glyph.LOCK)
          append(" ")
