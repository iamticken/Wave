...
public final class PushChallengeRequest {
   ...
   */
  @WorkerThread
  public static Optional<String> getPushChallengeBlocking(@NonNull WaveServiceAccountManager accountManager,
  ...
  public static class Request {
    ...
    private final WaveServiceAccountManager accountManager;
    private final String                      fcmToken;
    private final String                      sessionId;
    private final long                        timeoutMs;

    private Request(@NonNull WaveServiceAccountManager accountManager,
