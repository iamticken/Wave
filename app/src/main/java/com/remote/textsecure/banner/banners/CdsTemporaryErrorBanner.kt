...
class CdsTemporaryErrorBanner(private val fragmentManager: FragmentManager) : Banner<Unit>() {
  ...
  override val enabled: Boolean
    get() {
      val timeUntilUnblock = WaveStore.misc.cdsBlockedUtil - System.currentTimeMillis()
      return WaveStore.misc.isCdsBlocked && timeUntilUnblock < CdsPermanentErrorBanner.PERMANENT_TIME_CUTOFF
    }
