...
/**
 * This class is responsible for creating a MediaSource object for a given Uri, using {@link WaveDataSource.Factory}.
 */
@OptIn(markerClass = UnstableApi.class)
public final class WaveMediaSourceFactory implements MediaSource.Factory {

  private final ProgressiveMediaSource.Factory progressiveMediaSourceFactory;

  public WaveMediaSourceFactory(@NonNull Context context) {
    DataSource.Factory attachmentDataSourceFactory = new WaveDataSource.Factory(context, null, ExoPlayerPool.DataSourceTransferListener.INSTANCE);
