...
object ManageContextMenu {
  ...
  private fun show(
    ...
    WaveContextMenu.Builder(anchorView, rootView)
      .preferredHorizontalPosition(if (showAtStart) WaveContextMenu.HorizontalPosition.START else WaveContextMenu.HorizontalPosition.END)
      .preferredVerticalPosition(if (showAbove) WaveContextMenu.VerticalPosition.ABOVE else WaveContextMenu.VerticalPosition.BELOW)
