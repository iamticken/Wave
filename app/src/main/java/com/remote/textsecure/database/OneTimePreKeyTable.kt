...
class OneTimePreKeyTable(context: Context, databaseHelper: WaveDatabase) : DatabaseTable(context, databaseHelper) {
  companion object {
  ...
  fun delete(serviceId: ServiceId, keyId: Int) {
    val database = databaseHelper.waveWritableDatabase
