 ...
 */
class NotificationProfileTables(context: Context, databaseHelper: WaveDatabase) : DatabaseTable(context, databaseHelper), RecipientIdDatabaseReference {
  ...
  fun insertNotificationProfileFromStorageSync(notificationProfileRecord: WaveNotificationProfileRecord) {
  ...
  fun updateNotificationProfileFromStorageSync(notificationProfileRecord: WaveNotificationProfileRecord) {
    val profile = notificationProfileRecord.proto
