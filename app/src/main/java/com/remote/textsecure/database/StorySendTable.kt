 ...
 */
class StorySendTable(context: Context, databaseHelper: WaveDatabase) : DatabaseTable(context, databaseHelper), RecipientIdDatabaseReference {
  ...
  fun applySentStoryManifest(remoteManifest: SentStorySyncManifest, sentTimestamp: Long) {
    writableDatabase.withinTransaction {
      ...
      messagesWithoutAnyReceivers.forEach {
        WaveDatabase.messages.markAsRemoteDelete(it)
        WaveDatabase.messages.deleteRemotelyDeletedStory(it)
      }
    }
  }
