  ...
  public static void execute(SQLiteDatabase db) {
    ...
    try (Cursor cursor = db.query("recipient_preferences", null, null, null, null, null, null)) {
      while (cursor != null && cursor.moveToNext()) {
        ...
        values.put("wave_profile_name", cursor.getString(cursor.getColumnIndexOrThrow("wave_profile_name")));
        values.put("wave_profile_avatar", cursor.getString(cursor.getColumnIndexOrThrow("wave_profile_avatar")));
