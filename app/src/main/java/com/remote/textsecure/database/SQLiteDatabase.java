...
import android.os.CancellationWave;
...
public class SQLiteDatabase implements SupportSQLiteDatabase {
  ...
  @Override
  public Cursor query(SupportSQLiteQuery query, CancellationWave cancellationWave) {
    DatabaseMonitor.onSql(query.getSql(), null);
    return wrapped.query(query, cancellationWave);
  }
