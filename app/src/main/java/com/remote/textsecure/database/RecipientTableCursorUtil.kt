...
import org.wave.core.util.optionalBlob
import org.wave.core.util.optionalBoolean
import org.wave.core.util.optionalInt
import org.wave.core.util.optionalLong
...
object RecipientTableCursorUtil {
  ...
  fun getRecord(context: Context, cursor: Cursor, idColumnName: String): RecipientRecord {
    ...
    return RecipientRecord(
      ...
      waveProfileName = ProfileName.fromParts(cursor.requireString(RecipientTable.PROFILE_GIVEN_NAME), cursor.requireString(RecipientTable.PROFILE_FAMILY_NAME)),
      waveProfileAvatar = cursor.requireString(RecipientTable.PROFILE_AVATAR),
