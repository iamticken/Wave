 ...
 */
class ReactionTable(context: Context, databaseHelper: WaveDatabase) : DatabaseTable(context, databaseHelper), RecipientIdDatabaseReference {
  ...
  fun addReaction(messageId: MessageId, reaction: ReactionRecord) {
    ...
    try {
      ...
      WaveDatabase.messages.updateReactionsUnread(writableDatabase, messageId.id, hasReactions(messageId), false)
  ...
  fun deleteReaction(messageId: MessageId, recipientId: RecipientId) {
    ...
    try {
      ...
      WaveDatabase.messages.updateReactionsUnread(writableDatabase, messageId.id, hasReactions(messageId), true)
