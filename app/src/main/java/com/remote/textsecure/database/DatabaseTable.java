...
public abstract class DatabaseTable {
  ...
  protected       WaveDatabase databaseHelper;
  ...
  public DatabaseTable(Context context, WaveDatabase databaseHelper) {
  ...
  public void reset(WaveDatabase databaseHelper) {
    this.databaseHelper = databaseHelper;
  }

  public SQLiteDatabase getReadableDatabase() {
    return databaseHelper.getWaveReadableDatabase();
  }

  public SQLiteDatabase getWritableDatabase() {
    return databaseHelper.getWaveWritableDatabase();
  }
}
