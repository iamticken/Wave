 ...
 * tables.
 */
public class KeyValueDatabase extends SQLiteOpenHelper implements WaveDatabaseOpenHelper, KeyValuePersistentStorage {

  private static final String TAG = Log.tag(KeyValueDatabase.class);

  private static final int    DATABASE_VERSION = 1;
  public  static final String DATABASE_NAME    = "wave-key-value.db";
