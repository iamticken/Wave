...
data class ViewColorSet(
  ...
  companion object {
    val PRIMARY = ViewColorSet(
      foreground = ViewColor.ColorResource(R.color.wave_colorOnPrimary),
      background = ViewColor.ColorResource(R.color.wave_colorPrimary)
    )

    fun forCustomColor(@ColorInt customColor: Int): ViewColorSet {
      return ViewColorSet(
        foreground = ViewColor.ColorResource(R.color.wave_colorOnCustom),
