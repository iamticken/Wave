  ...
  fun requestCameraPermission(
    ...
    if (!isAskingForPermission) {
      ...
      Permissions.with(activity)
        ...
        .onAnyDenied { Toast.makeText(activity, R.string.WebRtcCallActivity__wave_needs_camera_access_enable_video, Toast.LENGTH_LONG).show() }
  ...
  fun requestAudioPermission(
    ...
    if (!isAskingForPermission) {
      ...
      Permissions.with(activity)
        ...
        .onAnyDenied {
          Toast.makeText(activity, R.string.WebRtcCallActivity__wave_needs_microphone_start_call, Toast.LENGTH_LONG).show()
          onDenied.run()
        }
        .onAnyPermanentlyDenied {
      ...
      Permissions.with(activity)
        ...
        .onSomeDenied { deniedPermissions: List<String?> ->
          if (deniedPermissions.contains(Manifest.permission.RECORD_AUDIO)) {
            ...
            Toast.makeText(activity, R.string.WebRtcCallActivity__wave_needs_camera_access_enable_video, Toast.LENGTH_LONG).show()
          }
        }
        .execute()
    }
