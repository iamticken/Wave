...
public final class WebRtcControls {
  ...
  public static final WebRtcControls PIP  = new WebRtcControls(false,
                                                               ...
                                                               null,
                                                               FoldableState.flat(),
                                                               WaveAudioManager.AudioDevice.NONE,
                                                               emptySet(),
                                                               false,
                                                               false);
  ...
  private final WaveAudioManager.AudioDevice      activeDevice;
  private final Set<WaveAudioManager.AudioDevice> availableDevices;
  ...
  public WebRtcControls(boolean isLocalVideoEnabled,
                 ...
                 @NonNull WaveAudioManager.AudioDevice activeDevice,
                 @NonNull Set<WaveAudioManager.AudioDevice> availableDevices,
                 boolean isCallLink,
  ...
  public boolean isBluetoothHeadsetAvailableForAudioToggle() {
    return availableDevices.contains(WaveAudioManager.AudioDevice.BLUETOOTH);
  }

  public boolean isWiredHeadsetAvailableForAudioToggle() {
    return availableDevices.contains(WaveAudioManager.AudioDevice.WIRED_HEADSET);
  }
