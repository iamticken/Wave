...
enum class AppIconPreset(private val componentName: String, @DrawableRes val iconPreviewResId: Int, @StringRes val labelResId: Int) {
  ...
  WHITE(".RoutingActivityAltWhite", R.drawable.ic_app_icon_wave_white_top_preview, R.string.app_name),
  COLOR(".RoutingActivityAltColor", R.drawable.ic_app_icon_wave_color_top_preview, R.string.app_name),
  DARK(".RoutingActivityAltDark", R.drawable.ic_app_icon_wave_dark_top_preview, R.string.app_name),
  DARK_VARIANT(".RoutingActivityAltDarkVariant", R.drawable.ic_app_icon_wave_dark_variant_top_preview, R.string.app_name),
