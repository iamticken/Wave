...
class TransferProgressView @JvmOverloads constructor(
  ...
  init {
    ...
    val waveCustomColor = ContextCompat.getColor(context, R.color.wave_colorOnCustom)
    val waveTransparent2 = ContextCompat.getColor(context, R.color.wave_colorTransparent2)

    iconColor = typedArray.getColor(R.styleable.TransferProgressView_transferIconColor, waveCustomColor)
    progressColor = typedArray.getColor(R.styleable.TransferProgressView_progressColor, waveCustomColor)
    trackColor = typedArray.getColor(R.styleable.TransferProgressView_trackColor, waveTransparent2)
