  ...
  Scaffold { contentPadding ->
    ...
    Column(
      ...
      Row(
        ...
        Icon(
          imageVector = ImageVector.vectorResource(R.drawable.ic_wave_logo_small),
        ...
        Text(
          text = if (isVideoCall) {
            stringResource(R.string.WebRtcCallView__wave_video_call)
          } else {
            stringResource(R.string.WebRtcCallView__wave_call)
          },
