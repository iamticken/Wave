...
import org.thoughtcrime.securesms.registration.fragments.WaveStrengthPhoneStateListener
...
class ChangeNumberEnterCodeFragment : LoggingFragment(R.layout.fragment_change_number_enter_code) {
  ...
  private lateinit var phoneStateListener: WaveStrengthPhoneStateListener
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    phoneStateListener = WaveStrengthPhoneStateListener(this, PhoneStateCallback())
  ...
  private fun navigateUp() {
    if (WaveStore.misc.isChangeNumberLocked) {
  ...
  private inner class PhoneStateCallback : WaveStrengthPhoneStateListener.Callback {
    override fun onNoCellWavePresent() {
      bottomSheet.showSafely(childFragmentManager, BOTTOM_SHEET_TAG)
    }

    override fun onCellWavePresent() {
