...
class ManageDonationsViewModel : ViewModel() {
  ...
  fun refresh() {
    ...
    disposables += Single.fromCallable { WaveDatabase.donationReceipts.hasReceipts() }.subscribeOn(Schedulers.io()).subscribe { hasReceipts ->
    ...
    disposables += Observable.combineLatest(
      WaveStore.inAppPayments.observablePendingOneTimeDonation,
