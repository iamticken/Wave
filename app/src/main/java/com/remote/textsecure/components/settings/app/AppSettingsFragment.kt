        ...
        when (state.backupFailureState) {
          BackupFailureState.SUBSCRIPTION_STATE_MISMATCH -> {
            item {
              ...
              BackupsWarningRow(
                text = stringResource(R.string.AppSettingsFragment__renew_your_wave_backups_subscription),
                onClick = {
        ...
        if (state.isPrimaryDevice) {
          ...
          item {
            ...
            Rows.TextRow(
              text = {
                Text(
                  text = stringResource(R.string.preferences__donate_to_wave),
                ...
                if (state.hasExpiredGiftBadge) {
                  Icon(
                    ...
                    tint = colorResource(R.color.wave_accent_primary),
  ...
  Row(
    ...
    Column(
      ...
      val prettyPhoneNumber = if (LocalInspectionMode.current) {
        ...
        remember(self.e164) {
          WaveE164Util.prettyPrint(self.e164)
        }
      }
    ...
    if (hasUsername) {
      IconButtons.IconButton(
        ...
        colors = IconButtons.iconButtonColors(
          containerColor = WaveTheme.colors.colorSurface4
        )
      ) {
        Icon(
