...
import org.wave.core.ui.compose.TextFields.TextField
import org.wave.core.util.Base64
import org.wave.core.util.Hex
import org.wave.core.util.getLength
        ...
        Screen(
          ...
          onImportNewStyleLocalBackupClicked = {
            MaterialAlertDialogBuilder(context)
              ...
              .setPositiveButton("Wipe and restore") { _, _ -> viewModel.import(WaveStore.settings.waveBackupDirectory!!) }
              .show()
          },
  ...
  Surface {
    Column(
      ...
      Rows.TextRow(
        ...
        onClick = {
          Util.copyToClipboard(context, WaveStore.account.accountEntropyPool.value)
      ...
      Rows.TextRow(
        ...
        onClick = {
          Util.copyToClipboard(context, Hex.toStringCondensed(WaveStore.account.accountEntropyPool.deriveMessageBackupKey().value))
          Toast.makeText(context, "Copied!", Toast.LENGTH_SHORT).show()
        }
      )
      ...
      Rows.TextRow(
        ...
        onClick = {
          Util.copyToClipboard(context, Base64.encodeWithoutPadding(WaveStore.backup.mediaRootBackupKey.deriveBackupId(WaveStore.account.requireAci()).value))
          Toast.makeText(context, "Copied!", Toast.LENGTH_SHORT).show()
        }
      )
