...
fun CallStateUpdatePopup(
  ...
  Row(
    ...
    modifier = modifier
      .background(
        color = colorResource(id = R.color.wave_light_colorSecondaryContainer),
    ...
    if (callControlsChange.iconRes != null) {
      Icon(
        ...
        tint = colorResource(id = R.color.wave_light_colorOnSecondaryContainer),
    ...
    Text(
      ...
      color = colorResource(id = R.color.wave_light_colorOnSecondaryContainer)
    )
  }
}
