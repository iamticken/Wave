...
open class InsetAwareConstraintLayout @JvmOverloads constructor(
  ...
  private fun getKeyboardHeight(): Int {
    val height = if (isLandscape()) {
      WaveStore.misc.keyboardLandscapeHeight
    } else {
      WaveStore.misc.keyboardPortraitHeight
    }
  ...
  private fun setKeyboardHeight(height: Int) {
    if (isLandscape()) {
      WaveStore.misc.keyboardLandscapeHeight = height
    } else {
      WaveStore.misc.keyboardPortraitHeight = height
    }
  }
