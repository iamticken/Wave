  ...
  Scaffolds.Settings(
    ...
    LazyColumn(
      ...
      if (backupsSettingsState.showBackupTierInternalOverride) {
        item {
          Column(modifier = Modifier.padding(horizontal = dimensionResource(id = org.wave.core.ui.R.dimen.gutter))) {
            Text(
              text = "ALPHA ONLY",
...
private fun NeverEnabledBackupsRow(
  ...
  Rows.TextRow(
    ...
    text = {
      Column {
        TextWithBetaLabel(
          text = stringResource(R.string.RemoteBackupsSettingsFragment__wave_backups),
          textStyle = MaterialTheme.typography.bodyLarge
        )

        Text(
          text = stringResource(R.string.BackupsSettingsFragment_automatic_backups_with_waves),
          color = MaterialTheme.colorScheme.onSurfaceVariant,
          style = MaterialTheme.typography.bodyMedium
        )
...
private fun InternalBackupOverrideRow(
  ...
  val deletionState by WaveStore.backup.deletionStateFlow.collectAsStateWithLifecycle(WaveStore.backup.deletionState)
