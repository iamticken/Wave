  ...
  Scaffold(
    topBar = {
      TopAppBar(
        ...
        colors = if (listState.canScrollBackward) TopAppBarDefaults.topAppBarColors(containerColor = WaveTheme.colors.colorSurface2) else TopAppBarDefaults.topAppBarColors()
      )
    }
  ) {
        ...
        item {
          Image(
            ...
            modifier = Modifier
              .size(72.dp)
              .background(
                WaveTheme.colors.colorSurface2,
                CircleShape
              )
              .padding(18.dp)
          )
