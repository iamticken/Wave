...
class UsernameQrScannerActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContent {
      ...
      WaveTheme(isDarkMode = DynamicTheme.isDarkTheme(LocalContext.current)) {
        Content(
          lifecycleOwner = this,
  ...
  private fun askCameraPermissions() {
    Permissions.with(this)
      ...
      .ifNecessary()
      .withPermanentDenialDialog(getString(R.string.CameraXFragment_wave_needs_camera_access_scan_qr_code), null, R.string.CameraXFragment_allow_access_camera, R.string.CameraXFragment_to_scan_qr_codes, supportFragmentManager)
      .onAnyDenied { Toast.makeText(this, R.string.CameraXFragment_wave_needs_camera_access_scan_qr_code, Toast.LENGTH_LONG).show() }
      .execute()
  }
