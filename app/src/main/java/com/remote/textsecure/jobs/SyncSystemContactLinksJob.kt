...
import org.wave.contacts.ContactLinkConfiguration
...
/**
 * This job makes sure all of the contact "links" are up-to-date. The links are the actions you see when you look at a Wave user in your system contacts
...
class SyncSystemContactLinksJob private constructor(parameters: Parameters) : BaseJob(parameters) {
  ...
  override fun onRun() {
    ...
    val e164sForLinking: Set<String> = WaveDatabase.recipients.getE164sForSystemContactLinks()
  ...
  companion object {
    ...
    fun buildContactLinkConfiguration(context: Context, account: Account): ContactLinkConfiguration {
      return ContactLinkConfiguration(
        ...
        callPrompt = { e164 -> context.getString(R.string.ContactsDatabase_wave_call_s, e164) },
        videoCallPrompt = { e164 -> context.getString(R.string.ContactsDatabase_wave_video_call_s, e164) },
        e164Formatter = { number -> WaveE164Util.formatAsE164(number) },
