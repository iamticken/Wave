  ...
  override fun run(): Result {
    if (NotificationChannels.getInstance().areNotificationsEnabled()) {
      ...
      if (BuildConfig.MANAGES_APP_UPDATES) {
        ...
        intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://wave.org/android/apk"))
      } else {
      ...
      val builder = NotificationCompat.Builder(context, NotificationChannels.getInstance().APP_ALERTS)
        ...
        .setContentTitle(context.getString(R.string.DeprecatedNotificationJob_update_wave))
        .setContentText(context.getString(R.string.DeprecatedNotificationJob_this_version_of_wave_has_expired))
