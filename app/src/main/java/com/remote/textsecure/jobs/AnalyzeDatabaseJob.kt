...
import org.wave.core.util.getAllTables
import org.wave.core.util.logTime
...
class AnalyzeDatabaseJob private constructor(
  ...
  override fun run(): Result {
    val tables = WaveDatabase.rawDatabase.getAllTables()
      .sorted()
    ...
    logTime(TAG, "analyze-$table", decimalPlaces = 2) {
      WaveDatabase.rawDatabase.rawQuery("PRAGMA analysis_limit=1000").close()
      WaveDatabase.rawDatabase.rawQuery("ANALYZE $table").close()
    }
