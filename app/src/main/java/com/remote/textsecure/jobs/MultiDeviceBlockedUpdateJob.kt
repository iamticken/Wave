...
class MultiDeviceBlockedUpdateJob private constructor(parameters: Parameters) : BaseJob(parameters) {
  ...
  public override fun onRun() {
    ...
    val blocked: List<RecipientRecord> = WaveDatabase.recipients.getBlocked()
    ...
    AppDependencies.waveServiceMessageSender.sendSyncMessage(
      WaveServiceSyncMessage.forBlocked(BlockedListMessage(blockedIndividuals, blockedGroups))
    )
  }
