...
public final class MultiDeviceOutgoingPaymentSyncJob extends BaseJob {
  ...
  protected void onRun() throws Exception {
    ...
    PaymentTable.PaymentTransaction payment = WaveDatabase.payments().getPayment(uuid);
    ...
    AppDependencies.getWaveServiceMessageSender()
                   .sendSyncMessage(WaveServiceSyncMessage.forOutgoingPayment(outgoingPaymentMessage)
                   );
  }
