...
public class MultiDeviceProfileKeyUpdateJob extends BaseJob {
  ...
  public void onRun() throws IOException, UntrustedIdentityException {
    ...
    out.write(new DeviceContact(Optional.ofNullable(WaveStore.account().getAci()),
                                Optional.ofNullable(WaveStore.account().getE164()),
                                Optional.empty(),
                                Optional.empty(),
                                Optional.empty(),
                                Optional.empty(),
    ...
    WaveServiceAttachmentStream attachmentStream = WaveServiceAttachment.newStreamBuilder()
    ...
    WaveServiceSyncMessage syncMessage = WaveServiceSyncMessage.forContacts(new ContactsMessage(attachmentStream, false));
