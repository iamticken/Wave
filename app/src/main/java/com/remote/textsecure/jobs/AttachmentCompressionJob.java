...
import org.thoughtcrime.securesms.video.interfaces.TranscoderCancelationWave;
...
public final class AttachmentCompressionJob extends BaseJob {
  ...
  public void onAdded() {
    ...
    final AttachmentTable    database   = WaveDatabase.attachments();
  ...
  public void onRun() throws Exception {
    ...
    AttachmentTable    database           = WaveDatabase.attachments();
  ...
  private static @NonNull DatabaseAttachment transcodeVideoIfNeededToDatabase(@NonNull Context context,
                                                                              ...
                                                                              @NonNull TranscoderCancelationWave cancelationWave)
      throws UndeliverableMessageException
  {

    if (cancelationWave.isCanceled()) {
