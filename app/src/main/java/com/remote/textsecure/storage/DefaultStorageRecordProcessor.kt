 ...
 */
abstract class DefaultStorageRecordProcessor<E : WaveRecord<*>> : StorageRecordProcessor<E>, Comparator<E> {
  companion object {
   ...
   * general we rely on WaveRecords to implement an equals() that includes the StorageId, so using
