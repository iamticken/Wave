...
public class WebRtcServiceStateBuilder {
  ...
  public class LocalDeviceStateBuilder {
    ...
    public @NonNull LocalDeviceStateBuilder setActiveDevice(@NonNull WaveAudioManager.AudioDevice audioDevice) {
      toBuild.setActiveDevice(audioDevice);
      return this;
    }

    public @NonNull LocalDeviceStateBuilder setAvailableDevices(@NonNull Set<WaveAudioManager.AudioDevice> availableDevices) {
