...
class CallLinkConnectedActionProcessor(
  ...
  override fun handleGroupJoinedMembershipChanged(currentState: WebRtcServiceState): WebRtcServiceState {
    ...
    val callLink: CallLinkTable.CallLink = WaveDatabase.callLinks.getCallLinkByRoomId(callLinkRoomId) ?: return superState
    ...
    AppDependencies.waveCallManager.emitCallLinkPeekInfoUpdate(callLink.recipientId, peekInfo)
