...
object DeviceSpecificNotificationConfig {
  ...
  private const val GENERAL_SUPPORT_URL = "https://support.wave.org/hc/articles/360007318711#android_notifications_troubleshooting"
   ...
   * @param link represents the Wave support url that corresponds to this device model
