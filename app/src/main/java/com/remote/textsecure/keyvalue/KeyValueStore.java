...
import org.thoughtcrime.securesms.util.WaveUncaughtExceptionHandler;
 ...
 * {@link WaveUncaughtExceptionHandler}, meaning all write should finish barring a native crash
...
public final class KeyValueStore implements KeyValueReader {
  ...
  public KeyValueStore(@NonNull KeyValuePersistentStorage storage) {
    this.executor = WaveExecutors.newCachedSingleThreadExecutor("wave-KeyValueStore", ThreadUtil.PRIORITY_BACKGROUND_THREAD);
