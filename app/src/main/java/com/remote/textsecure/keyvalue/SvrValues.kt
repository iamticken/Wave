...
import org.wave.core.util.StringStringSerializer
import org.wave.core.util.logging.Log
import org.whispersystems.waveservice.api.kbs.PinHashUtil.localPinHash

class SvrValues internal constructor(store: KeyValueStore) : WaveStoreValues(store) {
  companion object {
  ...
  val masterKey: MasterKey
    get() = WaveStore.account.accountEntropyPool.deriveMasterKey()
