...
final class LogSectionNotifications implements LogSection {
  ...
  public @NonNull CharSequence getContent(@NonNull Context context) {
    ...
    output.append("Message notifications: ").append(WaveStore.settings().isMessageNotificationsEnabled()).append("\n")
          .append("Call notifications   : ").append(WaveStore.settings().isCallNotificationsEnabled()).append("\n")
          .append("New contact alerts   : ").append(WaveStore.settings().isNotifyWhenContactJoinsWave()).append("\n")
          .append("In-chat sounds       : ").append(WaveStore.settings().isMessageNotificationsInChatSoundsEnabled()).append("\n")
          .append("Repeat alerts        : ").append(WaveStore.settings().getMessageNotificationsRepeatAlerts()).append("\n")
          .append("Notification display : ").append(WaveStore.settings().getMessageNotificationsPrivacy()).append("\n\n");
