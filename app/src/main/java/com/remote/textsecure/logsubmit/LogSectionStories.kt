...
class LogSectionStories : LogSection {
  ...
  override fun getContent(context: Context): CharSequence {
    ...
    if (Recipient.isSelfSet) {
      val myStoryRecord = WaveDatabase.distributionLists.getList(DistributionListId.MY_STORY)
      ...
      if (myStoryRecord != null) {
        ...
        output.append("Raw Distribution ID: ${WaveDatabase.distributionLists.getRawDistributionId(myStoryRecord.id)}\n")
