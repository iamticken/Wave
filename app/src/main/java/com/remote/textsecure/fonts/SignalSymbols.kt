...
/**
 * Helper object for working with the WaveSymbols font
 */
object WaveSymbols {
  ...
  @Composable
  fun AnnotatedString.Builder.WaveSymbol(weight: Weight, glyph: Glyph) {
    withStyle(
      SpanStyle(
