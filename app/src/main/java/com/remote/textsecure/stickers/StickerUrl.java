...
public class StickerUrl {
  ...
  private static final Pattern STICKER_URL_PATTERN = Pattern.compile("^https://wave\\.art/addstickers/#pack_id=(.*)&pack_key=(.*)$");
  ...
  public static String createShareLink(@NonNull String packId, @NonNull String packKey) {
    return "https://wave.art/addstickers/#pack_id=" + packId + "&pack_key=" + packKey;
  }
