...
public final class StickerPackPreviewRepository {
  ...
  private final WaveServiceMessageReceiver receiver;

  public StickerPackPreviewRepository() {
    this.receiver        = AppDependencies.getWaveServiceMessageReceiver();
    this.stickerDatabase = WaveDatabase.stickers();
  }
  ...
  private Optional<StickerManifestResult> getManifestRemote(@NonNull String packId, @NonNull String packKey) {
    try {
      ...
      WaveServiceStickerManifest remoteManifest = receiver.retrieveStickerManifest(packIdBytes, packKeyBytes);
  ...
  private Optional<StickerManifest.Sticker> toOptionalSticker(@NonNull String packId,
                                                              @NonNull String packKey,
                                                              @NonNull Optional<WaveServiceStickerManifest.StickerInfo> remoteSticker)
  {
  ...
  private StickerManifest.Sticker toSticker(@NonNull String packId,
                                            @NonNull String packKey,
                                            @NonNull WaveServiceStickerManifest.StickerInfo remoteSticker)
  {
