 ...
 * voice, and video call a given contact on Wave. This job is necessary to ensure that all contacts have the correct
 * links in the system contacts app. At the time of writing, this job is adding the video call link and changing the
 * text of the voice call link to "Wave Voice Call" instead of "Wave Call". This job could be reused in the future
