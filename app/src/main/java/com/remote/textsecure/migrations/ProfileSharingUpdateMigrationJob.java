...
public class ProfileSharingUpdateMigrationJob extends MigrationJob {
  ...
  public void performMigration() {
    long messageRequestEnableTime = WaveStore.misc().getMessageRequestEnableTime();
    WaveDatabase.recipients().markPreMessageRequestRecipientsAsProfileSharingEnabled(messageRequestEnableTime);
  }
