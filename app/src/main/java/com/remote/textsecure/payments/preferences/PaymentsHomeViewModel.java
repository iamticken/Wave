...
public class PaymentsHomeViewModel extends ViewModel {
                        ...
                        @NonNull CurrencyExchangeRepository currencyExchangeRepository)
  {
    ...
    this.balance                    = LiveDataUtil.mapDistinct(WaveStore.payments().liveMobileCoinBalance(), Balance::getFullAmount);
    ...
    LiveData<CurrencyExchange.ExchangeRate> liveExchangeRate = LiveDataUtil.combineLatest(WaveStore.payments().liveCurrentCurrency(),
  ...
  private static PaymentsHomeState.PaymentsState getPaymentsState() {
    PaymentsValues paymentsValues = WaveStore.payments();
  ...
  void checkPaymentActivationState() {
    ...
    boolean                         paymentsEnabled = WaveStore.payments().mobileCoinPaymentsEnabled();
