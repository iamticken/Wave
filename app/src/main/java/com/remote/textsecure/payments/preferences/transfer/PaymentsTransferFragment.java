...
public final class PaymentsTransferFragment extends LoggingFragment {
    ...
    try {
      ...
      if (ownAddress.equals(publicAddress)) {
        new MaterialAlertDialogBuilder(requireContext())
                       ...
                       .setMessage(R.string.PaymentsTransferFragment__you_cant_transfer_to_your_own_wave_wallet_address)
  ...
  private void scanQrCode() {
    Permissions.with(this)
               ...
               .ifNecessary()
               .withRationaleDialog(getString(R.string.CameraXFragment_allow_access_camera), getString(R.string.PaymentsTransferFragment__to_scan_a_qr_code_wave_needs), R.drawable.ic_camera_24)
               .withPermanentDenialDialog(getString(R.string.PaymentsTransferFragment__to_scan_a_qr_code_wave_needs_access_to_the_camera), null, R.string.CameraXFragment_allow_access_camera, R.string.CameraXFragment_to_scan_qr_codes, getParentFragmentManager())
               ...
               .onAnyDenied(() -> Toast.makeText(requireContext(), R.string.PaymentsTransferFragment__to_scan_a_qr_code_wave_needs_access_to_the_camera, Toast.LENGTH_LONG).show())
               .execute();
  }
