...
public final class DataExportUtil {
  ...
  public static @NonNull String createTsv() {
    ...
    List<PaymentTable.PaymentTransaction> paymentTransactions = WaveDatabase.payments().getAll();
    MobileCoinLedgerWrapper               ledger              = WaveStore.payments().liveMobileCoinLedger().getValue();
