  ...
  private void updateMoneyInputTarget(@NonNull InputTarget target) {
    ...
    switch (target) {
      case FIAT_MONEY:
        ...
        amount.setTextColor(ContextCompat.getColor(requireContext(), R.color.wave_text_secondary));
        exchange.setTextColor(ContextCompat.getColor(requireContext(), R.color.wave_text_primary));
        break;
      case MONEY:
        cryptoConstraintSet.applyTo(constraintLayout);
        exchange.setTextColor(ContextCompat.getColor(requireContext(), R.color.wave_text_secondary));
        amount.setTextColor(ContextCompat.getColor(requireContext(), R.color.wave_text_primary));
        break;
    }
  }
}
