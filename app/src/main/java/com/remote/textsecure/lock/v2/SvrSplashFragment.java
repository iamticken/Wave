...
public final class SvrSplashFragment extends Fragment {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    if (WaveStore.svr().isRegistrationLockEnabled()) {
      setUpRegLockEnabled();
    } else {
  ...
  private void setUpRegLockDisabled() {
    ...
    description.setText(R.string.KbsSplashFragment__pins_keep_information_stored_with_wave_encrypted);
  ...
  private void onCreatePin() {
    ...
    action.setIsPinChange(WaveStore.svr().hasPin());
