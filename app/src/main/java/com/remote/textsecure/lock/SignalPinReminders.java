...
/**
 * Reminder intervals for Wave PINs.
 */
public class WavePinReminders {

  private static final String TAG = Log.tag(WavePinReminders.class);
  ...
  private static final Map<Long, Integer> STRINGS = new HashMap<Long, Integer>() {{
    put(ONE_DAY, R.string.WavePinReminders_well_remind_you_again_tomorrow);
    put(THREE_DAYS, R.string.WavePinReminders_well_remind_you_again_in_a_few_days);
    put(ONE_WEEK, R.string.WavePinReminders_well_remind_you_again_in_a_week);
    put(TWO_WEEKS, R.string.WavePinReminders_well_remind_you_again_in_a_couple_weeks);
    put(FOUR_WEEKS, R.string.WavePinReminders_well_remind_you_again_in_a_month);
  }};

  private static final Map<Long, Integer> SKIP_STRINGS = new HashMap<Long, Integer>() {{
    put(ONE_DAY, R.string.WavePinReminders__well_remind_you_again_tomorrow);
    put(THREE_DAYS, R.string.WavePinReminders__well_remind_you_again_in_a_few_days);
    put(ONE_WEEK, R.string.WavePinReminders__well_remind_you_again_in_a_week);
    put(TWO_WEEKS, R.string.WavePinReminders__well_remind_you_again_in_a_couple_weeks);
    put(FOUR_WEEKS, R.string.WavePinReminders__well_remind_you_again_in_a_month);
  }};
  ...
  public static @StringRes int getReminderString(long interval) {
    ...
    if (stringRes != null) {
      ...
      return R.string.WavePinReminders_well_remind_you_again_later;
    }
  }
  ...
  public static @StringRes int getSkipReminderString(long interval) {
    ...
    if (stringRes != null) {
      ...
      Log.w(TAG, "Couldn't find a string for interval " + interval);
      return R.string.WavePinReminders__well_remind_you_again_later;
    }
  }
}
