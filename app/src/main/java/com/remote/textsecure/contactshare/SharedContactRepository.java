...
import org.wave.contacts.SystemContactsRepository.NameDetails;
import org.wave.contacts.SystemContactsRepository.PhoneDetails;
...
public class SharedContactRepository {
  ...
  private @Nullable AvatarInfo getAvatarInfo(long contactId, List<Phone> phoneNumbers) {
    ...
    for (Phone phoneNumber : phoneNumbers) {
      String formattedNumber = WaveE164Util.formatAsE164(phoneNumber.getNumber());
