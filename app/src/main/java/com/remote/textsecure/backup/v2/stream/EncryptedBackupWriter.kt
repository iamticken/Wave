...
import org.wave.core.util.stream.MacOutputStream
...
import org.thoughtcrime.securesms.backup.v2.stream.EncryptedBackupReader.Companion.createForWaveBackup
...
class EncryptedBackupWriter private constructor(
  ...
  companion object {
    ...
    /**
     * Create a writer for a local backup or for a transfer to a linked device. Basically everything that isn't [createForWaveBackup].
