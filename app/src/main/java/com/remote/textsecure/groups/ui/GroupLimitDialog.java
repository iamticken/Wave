...
public final class GroupLimitDialog {
  ...
  public static void showHardLimitMessage(@NonNull Context context) {
    ...
    new MaterialAlertDialogBuilder(context)
        ...
        .setMessage(context.getString(R.string.ContactSelectionListFragment_wave_groups_can_have_a_maximum_of_s_members, formattedLimit))
  ...
  public static void showRecommendedLimitMessage(@NonNull Context context) {
    ...
    new MaterialAlertDialogBuilder(context)
        ...
        .setMessage(context.getString(R.string.ContactSelectionListFragment_wave_groups_perform_best_with_s_members_or_fewer, formattedLimit))
        .setPositiveButton(android.R.string.ok, null)
        .show();
  }
}
