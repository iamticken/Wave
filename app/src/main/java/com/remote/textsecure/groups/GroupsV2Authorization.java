...
import org.wave.libwave.zkgroup.calllinks.CallLinkAuthCredential;
...
import org.whispersystems.waveservice.api.groupsv2.NoCredentialForRedemptionTimeException;
...
public class GroupsV2Authorization {
      ...
      throws NoCredentialForRedemptionTimeException, VerificationFailedException
  {
    ...
    CallLinkAuthCredential credential     = authCredentialResponse.receive(
        Recipient.self().requireAci().getLibWaveAci(),
