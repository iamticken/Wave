...
class StoryViewerPageFragment :
  ...
  private fun presentBottomBar(post: StoryPost, replyState: StoryViewerPageState.ReplyState, isReceiptsEnabled: Boolean) {
    ...
    viewsAndReplies.iconTint = ColorStateList.valueOf(ContextCompat.getColor(requireContext(), R.color.wave_colorOnSurface))
    ...
    if (sendingProgressDrawable == null) {
      sendingProgressDrawable = IndeterminateDrawable.createCircularDrawable(
        ...
        CircularProgressIndicatorSpec(requireContext(), null).apply {
          ...
          indicatorColors = intArrayOf(ContextCompat.getColor(requireContext(), R.color.wave_dark_colorNeutralInverse))
          trackThickness = 2.dp
        }
      ).apply {
  ...
  private fun presentPartialSendBottomBar() {
    ...
    viewsAndReplies.iconTint = ColorStateList.valueOf(ContextCompat.getColor(requireContext(), R.color.wave_light_colorError))
