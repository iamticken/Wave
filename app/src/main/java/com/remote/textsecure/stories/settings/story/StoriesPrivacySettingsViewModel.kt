...
class StoriesPrivacySettingsViewModel(
  ...
  private val store = RxStore(
    StoriesPrivacySettingsState(
      ...
      areViewReceiptsEnabled = WaveStore.story.viewedReceiptsEnabled
    )
  )
  ...
  fun toggleViewReceipts() {
    WaveStore.story.viewedReceiptsEnabled = !WaveStore.story.viewedReceiptsEnabled
    store.update { it.copy(areViewReceiptsEnabled = WaveStore.story.viewedReceiptsEnabled) }
