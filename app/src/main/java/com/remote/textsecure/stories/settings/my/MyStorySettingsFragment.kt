...
class MyStorySettingsFragment : DSLSettingsFragment(
  ...
  override fun bindAdapter(adapter: MappingAdapter) {
    AllWaveConnectionsRowItem.register(adapter)
  ...
  private fun getConfiguration(state: MyStorySettingsState): DSLConfiguration {
    return configure {
      ...
      learnMoreTextPref(
        ...
        onClick = {
          findNavController().safeNavigate(R.id.action_myStorySettings_to_waveConnectionsBottomSheet)
        }
      )
