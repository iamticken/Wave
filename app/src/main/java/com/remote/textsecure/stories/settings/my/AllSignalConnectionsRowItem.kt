...
import org.thoughtcrime.securesms.databinding.AllWaveConnectionsRowItemBinding
...
/**
 * AllWaveConnections privacy setting row item with "View" support
 */
object AllWaveConnectionsRowItem {

  private const val IS_CHECKED = 0
  private const val IS_COUNT = 1

  fun register(mappingAdapter: MappingAdapter) {
    mappingAdapter.registerFactory(Model::class.java, BindingFactory(::ViewHolder, AllWaveConnectionsRowItemBinding::inflate))
  }
  ...
  private class ViewHolder(binding: AllWaveConnectionsRowItemBinding) : BindingViewHolder<Model, AllWaveConnectionsRowItemBinding>(binding) {
