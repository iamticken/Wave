...
class CameraXVideoCaptureHelper implements CameraButtonView.VideoCaptureListener {
  ...
  private void displayAudioRecordingPermissionsDialog() {
    Permissions.with(fragment)
               ...
               .withPermanentDenialDialog(fragment.getString(R.string.ConversationActivity_wave_needs_the_recording_permissions_to_capture_video), null, R.string.CameraXFragment_allow_access_microphone, R.string.CameraXFragment_to_capture_videos, fragment.getParentFragmentManager())
               .onAnyDenied(() -> Toast.makeText(fragment.requireContext(), R.string.CameraXFragment_wave_needs_microphone_access_video, Toast.LENGTH_LONG).show())
               .execute();
  }
