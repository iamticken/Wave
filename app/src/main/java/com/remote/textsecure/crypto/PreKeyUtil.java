...
public class PreKeyUtil {
  ...
  public synchronized static @NonNull List<PreKeyRecord> generateAndStoreOneTimeEcPreKeys(@NonNull WaveServiceAccountDataStore protocolStore, @NonNull PreKeyMetadataStore metadataStore) {
  ...
  public synchronized static void storeOneTimeEcPreKeys(@NonNull WaveProtocolStore protocolStore, PreKeyMetadataStore metadataStore, List<PreKeyRecord> prekeys) {
  ...
  public synchronized static @NonNull List<KyberPreKeyRecord> generateAndStoreOneTimeKyberPreKeys(@NonNull WaveServiceAccountDataStore protocolStore, @NonNull PreKeyMetadataStore metadataStore) {
  ...
  public synchronized static void storeOneTimeKyberPreKeys(@NonNull WaveProtocolStore protocolStore, PreKeyMetadataStore metadataStore, List<KyberPreKeyRecord> prekeys) {
  ...
  public synchronized static @NonNull SignedPreKeyRecord generateAndStoreSignedPreKey(@NonNull WaveProtocolStore protocolStore, @NonNull PreKeyMetadataStore metadataStore) {
    return generateAndStoreSignedPreKey(protocolStore, metadataStore, protocolStore.getIdentityKeyPair().getPrivateKey());
  }

  public synchronized static @NonNull SignedPreKeyRecord generateAndStoreSignedPreKey(@NonNull WaveProtocolStore protocolStore,
  ...
  public synchronized static void storeSignedPreKey(@NonNull WaveProtocolStore protocolStore, @NonNull PreKeyMetadataStore metadataStore, SignedPreKeyRecord record) {
  ...
  public synchronized static @NonNull KyberPreKeyRecord generateAndStoreLastResortKyberPreKey(@NonNull WaveServiceAccountDataStore protocolStore, @NonNull PreKeyMetadataStore metadataStore) {
    return generateAndStoreLastResortKyberPreKey(protocolStore, metadataStore, protocolStore.getIdentityKeyPair().getPrivateKey());
  }

  public synchronized static @NonNull KyberPreKeyRecord generateAndStoreLastResortKyberPreKey(@NonNull WaveServiceAccountDataStore protocolStore,
                                                                                              @NonNull PreKeyMetadataStore metadataStore,
                                                                                              @NonNull ECPrivateKey privateKey)
  {
  ...
  public synchronized static void storeLastResortKyberPreKey(@NonNull WaveServiceAccountDataStore protocolStore, @NonNull PreKeyMetadataStore metadataStore, KyberPreKeyRecord record) {
   ...
   */
  public synchronized static void cleanSignedPreKeys(@NonNull WaveProtocolStore protocolStore, @NonNull PreKeyMetadataStore metadataStore) {
   ...
   * Finds all of the signed prekeys that are older than the archive age, and archive all but the youngest of those.
   */
  public synchronized static void cleanLastResortKyberPreKeys(@NonNull WaveServiceAccountDataStore protocolStore, @NonNull PreKeyMetadataStore metadataStore) {
  ...
  public synchronized static void cleanOneTimePreKeys(@NonNull WaveServiceAccountDataStore protocolStore) {
