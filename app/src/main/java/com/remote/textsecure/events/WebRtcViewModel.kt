...
class WebRtcViewModel(state: WebRtcServiceState) {
  ...
  val activeDevice: WaveAudioManager.AudioDevice = state.localDeviceState.activeDevice
  val availableDevices: Set<WaveAudioManager.AudioDevice> = state.localDeviceState.availableDevices
