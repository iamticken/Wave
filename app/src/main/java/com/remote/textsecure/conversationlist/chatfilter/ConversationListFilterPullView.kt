...
class ConversationListFilterPullView @JvmOverloads constructor(
  ...
  private val pillDefaultBackgroundTint = ContextCompat.getColor(context, R.color.wave_colorSecondaryContainer)
  private val pillWillCloseBackgroundTint = ContextCompat.getColor(context, R.color.wave_colorSurface1)
