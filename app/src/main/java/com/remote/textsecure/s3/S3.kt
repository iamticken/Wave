...
import org.whispersystems.waveservice.internal.websocket.DefaultErrorMapper
...
object S3 {
  ...
  private val okHttpClient by lazy { AppDependencies.waveOkHttpClient }
  ...
  fun s3Url(path: String): URL {
    try {
      return URI("https", "updates2.wave.org", path, null).toURL()
