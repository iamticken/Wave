...
public final class ConversationUtil {
                                                               ...
                                                               @NonNull Direction direction)
  {
    ...
    long      threadId   = WaveDatabase.threads().getOrCreateThreadIdFor(resolved);
  ...
  private static @NonNull Person[] buildPersonsForGroup(@NonNull Context context, @NonNull GroupId groupId) {
    List<Recipient> members = WaveDatabase.groups().getGroupMembers(groupId, GroupTable.MemberSet.FULL_MEMBERS_EXCLUDING_SELF);
