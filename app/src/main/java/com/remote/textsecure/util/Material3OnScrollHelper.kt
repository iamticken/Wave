...
open class Material3OnScrollHelper(
  ...
  open val activeColorSet: ColorSet = ColorSet(
    toolbarColorRes = R.color.wave_colorSurface2,
    statusBarColorRes = R.color.wave_colorSurface2,
    chatFolderColorRes = R.color.wave_colorBackground
  )
  open val inactiveColorSet: ColorSet = ColorSet(
    toolbarColorRes = R.color.wave_colorBackground,
    statusBarColorRes = R.color.wave_colorBackground,
    chatFolderColorRes = R.color.wave_colorSurface2
  )
