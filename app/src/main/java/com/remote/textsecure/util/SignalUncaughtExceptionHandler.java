...
public class WaveUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {

  private static final String TAG = Log.tag(WaveUncaughtExceptionHandler.class);

  private final Thread.UncaughtExceptionHandler originalHandler;

  public WaveUncaughtExceptionHandler(@NonNull Thread.UncaughtExceptionHandler originalHandler) {
  ...
  public void uncaughtException(@NonNull Thread t, @NonNull Throwable e) {
    ...
    if (e instanceof SQLiteDatabaseCorruptException) {
      if (e.getMessage() != null && e.getMessage().contains("message_fts")) {
        ...
        WaveDatabase.messageSearch().fullyResetTables();
      } else {
