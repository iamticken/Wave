 ...
 * and the previous WaveAudioManager implementation would have required us to ask for (poorly labeled & scary) Bluetooth permissions.
 */
@RequiresApi(31)
class FullWaveAudioManagerApi31(context: Context, eventListener: EventListener?) : WaveAudioManager(context, eventListener) {
  private val TAG = "WaveAudioManager31"
