...
import org.whispersystems.waveservice.internal.push.DataMessage.Payment
...
object WaveServiceProtoUtil {
  ...
  fun AttachmentPointer.toPointer(stickerLocator: StickerLocator? = null): Attachment? {
    return try {
      val pointer = PointerAttachment.forPointer(Optional.of(toWaveServiceAttachmentPointer()), stickerLocator).orNull()
  ...
  fun AttachmentPointer.toWaveServiceAttachmentPointer(): WaveServiceAttachmentPointer {
    return AttachmentPointerUtil.createWaveAttachmentPointer(this)
  }
