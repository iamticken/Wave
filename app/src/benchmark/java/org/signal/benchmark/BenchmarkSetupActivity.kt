package org.wave.benchmark

import android.os.Bundle
import android.widget.TextView
import org.wave.benchmark.setup.TestMessages
import org.wave.benchmark.setup.TestUsers
...
class BenchmarkSetupActivity : BaseActivity() {
  ...
  private fun setupColdStart() {
    ...
    TestUsers.setupTestRecipients(50).forEach {
      ...
      WaveDatabase.messages.setAllMessagesRead()

      WaveDatabase.threads.update(WaveDatabase.threads.getOrCreateThreadIdFor(recipient = recipient), true)
    }
  }
