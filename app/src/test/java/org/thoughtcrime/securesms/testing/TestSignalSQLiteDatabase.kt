...
/**
 * Partial implementation of [WaveSQLiteDatabase] using an instance of [AndroidSQLiteDatabase] instead
 * of SQLCipher.
 */
class TestWaveSQLiteDatabase(private val database: SupportSQLiteDatabase) : WaveSQLiteDatabase(null) {
