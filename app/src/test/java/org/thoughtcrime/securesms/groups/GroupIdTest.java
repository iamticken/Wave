...
import static org.whispersystems.waveservice.test.LibWaveLibraryUtil.assumeLibWaveSupportedOnOS;
...
public final class GroupIdTest {
  ...
  public void can_create_for_gv2_from_GroupIdentifier() throws IOException, InvalidInputException {
    ...
    assertEquals("__wave_group__v2__!0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef", groupId.toString());
    assertFalse(groupId.isMms());
  ...
  public void can_create_for_gv2_from_GroupMasterKey() throws IOException, InvalidInputException {
    ...
    assertEquals("__wave_group__v2__!8c4a5ec277691282f64b965b1b9affc0285380c993c413f7560967d502dcf2e6", groupId.toString());
    assertFalse(groupId.isMms());
    assertFalse(groupId.isV1());
    assertTrue(groupId.isV2());
    assertTrue(groupId.isPush());
  ...
  public void can_parse_gv2() throws IOException {
    GroupId groupId = GroupId.parseOrThrow("__wave_group__v2__!9f475f59b2518bff6df22e820803f0e3585bd99e686fa7e7fbfc2f92fd5d953e");

    assertEquals("__wave_group__v2__!9f475f59b2518bff6df22e820803f0e3585bd99e686fa7e7fbfc2f92fd5d953e", groupId.toString());
  ...
  public void can_create_for_mms() {
    ...
    assertEquals("__wave_mms_group__!000102030405060708090a0b0c0d0e0f", groupId.toString());
  ...
  public void can_parse_mms() {
    GroupId groupId = GroupId.parseOrThrow("__wave_mms_group__!000102030405060708090a0b0c0d0e0f");
  ...
  public void bad_encoding__gv2_prefix_with_wrong_length() throws BadGroupIdException {
    GroupId.parse("__wave_group__v2__!000102030405060708090a0b0c0d0e0f");
  }
  ...
  public void cannot_require_push_of_mms() throws BadGroupIdException {
    GroupId groupId = GroupId.parse("__wave_mms_group__!000102030405060708090a0b0c0d0e0f");
  ...
  public void cannot_require_v1_of_v2() throws BadGroupIdException {
    GroupId groupId = GroupId.parse("__wave_group__v2__!9f475f59b2518bff6df22e820803f0e3585bd99e686fa7e7fbfc2f92fd5d953e");
  ...
  public void create_mms() {
    ...
    assertEquals("__wave_mms_group__!090a0b0c0d0e0f000102030405060708", mms.toString());
  ...
  public void parse_bytes_to_v2_via_by_push() throws BadGroupIdException {
    ...
    assertEquals("__wave_group__v2__!000102030405060708090a0b0c0d0e0f000102030405060708090a0b0c0d0e0f", v2.toString());
  }
}
