...
public final class LinkPreviewUtilTest_findValidPreviewUrls {
  ...
  public void contains_a_link() {
    LinkPreviewUtil.Links links = LinkPreviewUtil.findValidPreviewUrls("https://wave.org");

    assertEquals(1, links.size());

    assertTrue(links.containsUrl("https://wave.org"));
  }
  ...
  public void does_not_contain_link() {
    ...
    assertFalse(links.containsUrl("https://wave.org/page"));
  }

  @Test
  public void contains_two_links() {
    LinkPreviewUtil.Links links = LinkPreviewUtil.findValidPreviewUrls("Links https://wave.org https://android.com");
