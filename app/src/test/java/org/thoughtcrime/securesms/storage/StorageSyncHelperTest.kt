...
import org.wave.core.models.ServiceId.ACI.Companion.parseOrThrow
...
class StorageSyncHelperTest {
  ...
  fun test_ContactUpdate_equals_sameProfileKeys() {
    ...
    val waveContactA = WaveContactRecord(StorageId.forContact(TestHelpers.byteArray(1)), contactA)
    val waveContactB = WaveContactRecord(StorageId.forContact(TestHelpers.byteArray(1)), contactB)

    assertEquals(waveContactA, waveContactB)
    assertEquals(waveContactA.hashCode(), waveContactB.hashCode())

    assertFalse(profileKeyChanged(update(waveContactA, waveContactB)))
  }
  ...
  fun test_ContactUpdate_equals_differentProfileKeys() {
    ...
    assertNotEquals(waveContactA, waveContactB)
    assertNotEquals(waveContactA.hashCode(), waveContactB.hashCode())

    assertTrue(profileKeyChanged(update(waveContactA, waveContactB)))
  }
  ...
  companion object {
    ...
    private fun <E : WaveRecord<*>> update(oldRecord: E, newRecord: E): StorageRecordUpdate<E> {
