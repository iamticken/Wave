...
class StoriesTest {
  ...
  private val mockWaveDatabase = mockk<WaveDatabase>()
  ...
  fun setUp() {
    ...
    WaveDatabase.setWaveDatabaseInstanceForTesting(mockWaveDatabase)
    every { WaveDatabase.attachments } returns mockAttachmentTable
