...
import org.thoughtcrime.securesms.testing.TestWaveSQLiteDatabase

class WaveDatabaseMigrationRule(private val upgradedVersion: Int = 286) : ExternalResource() {
  ...
  override fun before() {
    ...
    WaveDatabaseMigrations.migrate(
  ...
  companion object {
    ...
    private fun inMemoryUpgradedDatabase(): SQLiteDatabase {
      ...
      return TestWaveSQLiteDatabase(helper.writableDatabase)
    }
