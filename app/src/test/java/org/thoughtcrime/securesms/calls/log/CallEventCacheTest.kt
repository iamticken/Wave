...
class CallEventCacheTest {
  ...
  fun setUp() {
    ...
    val waveCallManagerMock: WaveCallManager = mockk()
    every { waveCallManagerMock.peekInfoSnapshot } returns emptyMap()

    mockkStatic(AppDependencies::class)
    every { AppDependencies.waveCallManager } returns waveCallManagerMock
  }
