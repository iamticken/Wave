...
import org.wave.libwave.messagebackup.ComparableBackup
...
//  @Test
  ...
  private fun resetAllData() {
    ...
    WaveStore.resetCache()

    WaveStore.account.resetAccountEntropyPool()
    WaveStore.account.setE164(SELF_E164)
    WaveStore.account.setAci(SELF_ACI)
    WaveStore.account.setPni(SELF_PNI)
