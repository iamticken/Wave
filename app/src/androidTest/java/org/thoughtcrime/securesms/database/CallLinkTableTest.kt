...
//    WaveDatabase.callLinks.deleteNonAdminCallLinksOnOrBefore(TIMESTAMP_A - 500)
//    val callEvents = WaveDatabase.calls.getCalls(0, 2, "", CallLogFilter.ALL)
...
//  @Test
  fun givenTwoNonAdminCallLinks_whenIDeleteOnFirst_thenIExpectFirstDeleted() {
    insertTwoNonAdminCallLinksWithEvents()
    WaveDatabase.callLinks.deleteNonAdminCallLinksOnOrBefore(TIMESTAMP_A)
//    val callEvents = WaveDatabase.calls.getCalls(0, 2, "", CallLogFilter.ALL)
...
//  @Test
  fun givenTwoNonAdminCallLinks_whenIDeleteAfterFirstAndBeforeSecond_thenIExpectFirstDeleted() {
    insertTwoNonAdminCallLinksWithEvents()
    WaveDatabase.callLinks.deleteNonAdminCallLinksOnOrBefore(TIMESTAMP_B - 500)
//    val callEvents = WaveDatabase.calls.getCalls(0, 2, "", CallLogFilter.ALL)
//    assertEquals(1, callEvents.size)
//    assertEquals(TIMESTAMP_B, callEvents.first().record.timestamp)
  }
...
//  @Test
  fun givenTwoNonAdminCallLinks_whenIDeleteOnSecond_thenIExpectBothDeleted() {
    insertTwoNonAdminCallLinksWithEvents()
    WaveDatabase.callLinks.deleteNonAdminCallLinksOnOrBefore(TIMESTAMP_B)
//    val callEvents = WaveDatabase.calls.getCalls(0, 2, "", CallLogFilter.ALL)
...
//    assertEquals(0, callEvents.size)
  ...
  private fun insertCallLinkWithEvent(roomId: ByteArray, timestamp: Long) {
    ...
    val callLinkRecipient = WaveDatabase.recipients.getByCallLinkRoomId(CallLinkRoomId.fromBytes(roomId)).get()
