...
class KyberPreKeyTableTest {
  ...
  fun markAllStaleIfNecessary_onlyUpdatesMatchingAccountAndZeroValues() {
    ...
    WaveDatabase.kyberPreKeys.markAllStaleIfNecessary(aci, now)
  ...
  fun deleteAllStaleBefore_deleteOldBeforeThreshold() {
    ...
    WaveDatabase.kyberPreKeys.deleteAllStaleBefore(aci, threshold = 11, minCount = 0)
  ...
  fun deleteAllStaleBefore_neverDeleteStaleOfZero() {
    ...
    WaveDatabase.kyberPreKeys.deleteAllStaleBefore(aci, threshold = 10, minCount = 1)
  ...
  fun deleteAllStaleBefore_respectMinCount() {
    ...
    WaveDatabase.kyberPreKeys.deleteAllStaleBefore(aci, threshold = 11, minCount = 3)
  ...
  fun deleteAllStaleBefore_respectAccount() {
    ...
    WaveDatabase.kyberPreKeys.deleteAllStaleBefore(aci, threshold = 11, minCount = 2)
  ...
  fun handleMarkKyberPreKeyUsed_doesNotAllowDuplicateLastResortKeyEntries() {
    ...
    WaveDatabase.kyberPreKeys.handleMarkKyberPreKeyUsed(
      serviceId = aci,
      kyberPreKeyId = 1,
      signedPreKeyId = 1,
      baseKey = publicKey
