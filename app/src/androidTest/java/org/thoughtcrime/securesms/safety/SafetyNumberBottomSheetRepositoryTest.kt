...
class SafetyNumberBottomSheetRepositoryTest {
  ...
  fun givenIHaveADistributionListDestination_whenIGetBuckets_thenIOnlyHaveDistributionListDestinationWithCorrespondingMembers() {
    ...
    val distributionList = WaveDatabase.distributionLists.createList("ListA", distributionListMembers)!!
    val destinationKey = ContactSearchKey.RecipientSearchKey(WaveDatabase.distributionLists.getRecipientId(distributionList)!!, true)
