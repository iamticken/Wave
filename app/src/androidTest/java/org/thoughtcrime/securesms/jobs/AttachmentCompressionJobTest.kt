...
class AttachmentCompressionJobTest {
  ...
  fun testCompressionJobsWithDifferentTransformPropertiesCompleteSuccessfully() {
    ...
    val firstDatabaseAttachment = WaveDatabase.attachments.insertAttachmentForPreUpload(firstPreUpload)
    ...
    val secondDatabaseAttachment = WaveDatabase.attachments.insertAttachmentForPreUpload(secondPreUpload)
