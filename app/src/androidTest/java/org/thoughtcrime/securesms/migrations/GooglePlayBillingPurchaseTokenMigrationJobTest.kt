...
class GooglePlayBillingPurchaseTokenMigrationJobTest {
  ...
  @Before
  fun setUp() {
    WaveDatabase.inAppPaymentSubscribers.writableDatabase.deleteAll(InAppPaymentSubscriberTable.TABLE_NAME)
  }
  ...
  fun givenSubscriberWithPlaceholderAndNoBillingAccess_whenIRunJob_thenIExpectNoUpdate() {
    ...
    val sub = WaveDatabase.inAppPaymentSubscribers.getBackupsSubscriber()
