...
val waveNdkVersion: String by rootProject.extra
...
wire {
  ...
  protoPath {
    srcDir("${project.rootDir}/libwave-service/src/main/protowire")
  }
  // Handled by libwave
  prune("waveservice.DecryptionErrorMessage")
}
...
android {
  ...
  defaultConfig {
    ...
    project.ext.set("archivesBaseName", "Wave")

    manifestPlaceholders["mapsKey"] = "AIzaSyCSx9xea86GwDKGznCAULE9Y5a8b-TfN9U"

    buildConfigField("long", "BUILD_TIMESTAMP", getLastCommitTimestamp() + "L")
    buildConfigField("String", "GIT_HASH", "\"${getGitHash()}\"")
    buildConfigField("String", "SIGNAL_URL", "\"https://chat.wave.org\"")
    buildConfigField("String", "STORAGE_URL", "\"https://storage.wave.org\"")
    buildConfigField("String", "SIGNAL_CDN_URL", "\"https://cdn.wave.org\"")
    buildConfigField("String", "SIGNAL_CDN2_URL", "\"https://cdn2.wave.org\"")
    buildConfigField("String", "SIGNAL_CDN3_URL", "\"https://cdn3.wave.org\"")
    buildConfigField("String", "SIGNAL_CDSI_URL", "\"https://cdsi.wave.org\"")
    buildConfigField("String", "SIGNAL_SERVICE_STATUS_URL", "\"uptime.wave.org\"")
    buildConfigField("String", "SIGNAL_SVR2_URL", "\"https://svr2.wave.org\"")
    buildConfigField("String", "SIGNAL_SFU_URL", "\"https://sfu.voip.wave.org\"")
    buildConfigField("String", "SIGNAL_STAGING_SFU_URL", "\"https://sfu.staging.voip.wave.org\"")
    buildConfigField("String[]", "SIGNAL_SFU_INTERNAL_NAMES", "new String[]{\"Test\", \"Staging\", \"Development\"}")
    buildConfigField("String[]", "SIGNAL_SFU_INTERNAL_URLS", "new String[]{\"https://sfu.test.voip.wave.org\", \"https://sfu.staging.voip.wave.org\", \"https://sfu.staging.test.voip.wave.org\"}")
    buildConfigField("String", "CONTENT_PROXY_HOST", "\"contentproxy.wave.org\"")
    ...
    buildConfigField("String", "SIGNAL_CAPTCHA_URL", "\"https://wavecaptchas.org/registration/generate.html\"")
    buildConfigField("String", "RECAPTCHA_PROOF_URL", "\"https://wavecaptchas.org/challenge/generate.html\"")
    buildConfigField("org.wave.libwave.net.Network.Environment", "LIBSIGNAL_NET_ENV", "org.wave.libwave.net.Network.Environment.PRODUCTION")
    buildConfigField("int", "LIBSIGNAL_LOG_LEVEL", "org.wave.libwave.protocol.logging.WaveProtocolLogger.INFO")

    buildConfigField("String", "BUILD_DISTRIBUTION_TYPE", "\"unset\"")
    buildConfigField("String", "BUILD_ENVIRONMENT_TYPE", "\"unset\"")
    buildConfigField("String", "BUILD_VARIANT_TYPE", "\"unset\"")
    buildConfigField("String", "BADGE_STATIC_ROOT", "\"https://updates2.wave.org/static/badges/\"")
    ...
    testInstrumentationRunner = "org.thoughtcrime.securesms.testing.WaveTestRunner"
  ...
  productFlavors {
    ...
    create("website") {
      ...
      buildConfigField("String", "APK_UPDATE_MANIFEST_URL", "\"https://updates.wave.org/android/latest.json\"")
    ...
    create("staging") {
      ...
      buildConfigField("String", "SIGNAL_URL", "\"https://chat.staging.wave.org\"")
      buildConfigField("String", "STORAGE_URL", "\"https://storage-staging.wave.org\"")
      buildConfigField("String", "SIGNAL_CDN_URL", "\"https://cdn-staging.wave.org\"")
      buildConfigField("String", "SIGNAL_CDN2_URL", "\"https://cdn2-staging.wave.org\"")
      buildConfigField("String", "SIGNAL_CDN3_URL", "\"https://cdn3-staging.wave.org\"")
      buildConfigField("String", "SIGNAL_CDSI_URL", "\"https://cdsi.staging.wave.org\"")
      buildConfigField("String", "SIGNAL_SVR2_URL", "\"https://svr2.staging.wave.org\"")
      ...
      buildConfigField("String", "SIGNAL_CAPTCHA_URL", "\"https://wavecaptchas.org/staging/registration/generate.html\"")
      buildConfigField("String", "RECAPTCHA_PROOF_URL", "\"https://wavecaptchas.org/staging/challenge/generate.html\"")
      buildConfigField("org.wave.libwave.net.Network.Environment", "LIBSIGNAL_NET_ENV", "org.wave.libwave.net.Network.Environment.STAGING")
      buildConfigField("int", "LIBSIGNAL_LOG_LEVEL", "org.wave.libwave.protocol.logging.WaveProtocolLogger.DEBUG")
  ...
  androidComponents {
    ...
    onVariants { variant ->
      ...
      if (variant.buildType != "instrumentation") {
        variant.packaging.jniLibs.excludes.add("**/libwave_jni_testing.so")
      }
    }
  }
...
dependencies {
  ...
  implementation(project(":libwave-service"))
  ...
  implementation(libs.wave.aesgcmprovider)
  implementation(libs.libwave.android)
  implementation(libs.mobilecoin)
  implementation(libs.wave.ringrtc)
