...
import org.wave.core.util.serialization.ByteArrayToBase64Serializer
...
interface NetworkController {
  ...
  /**
   * Request an SMS verification code. On success, the server will send an SMS verification code to this Wave user.
   *
