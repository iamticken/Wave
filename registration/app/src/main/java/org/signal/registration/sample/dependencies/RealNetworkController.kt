...
package org.wave.registration.sample.dependencies

import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.withContext
import kotlinx.serialization.json.Json
import okhttp3.Response
import org.wave.registration.NetworkController
import org.wave.registration.NetworkController.AccountAttributes
import org.wave.registration.NetworkController.CreateSessionError
import org.wave.registration.NetworkController.GetSessionStatusError
import org.wave.registration.NetworkController.PreKeyCollection
import org.wave.registration.NetworkController.RegisterAccountError
import org.wave.registration.NetworkController.RegisterAccountResponse
import org.wave.registration.NetworkController.RegistrationLockResponse
import org.wave.registration.NetworkController.RegistrationNetworkResult
import org.wave.registration.NetworkController.RequestVerificationCodeError
import org.wave.registration.NetworkController.SessionMetadata
import org.wave.registration.NetworkController.SubmitVerificationCodeError
import org.wave.registration.NetworkController.ThirdPartyServiceErrorResponse
import org.wave.registration.NetworkController.UpdateSessionError
import org.wave.registration.NetworkController.VerificationCodeTransport
import org.whispersystems.waveservice.internal.push.PushServiceSocket
import java.io.IOException
import java.util.Locale
import kotlin.time.Duration
import kotlin.time.Duration.Companion.seconds
import org.whispersystems.waveservice.api.account.AccountAttributes as ServiceAccountAttributes
import org.whispersystems.waveservice.api.account.PreKeyCollection as ServicePreKeyCollection
...
class RealNetworkController(
  ...
  override fun getCaptchaUrl(): String {
    return "https://wavecaptchas.org/staging/registration/generate.html"
  }
