 ...
 *
 * This file has been modified by Wave.
 */
...
final class OutputSurface implements SurfaceTexture.OnFrameAvailableListener {
     ...
     * the OutputSurface object, after the onFrameAvailable callback has waveed that new
     * data is available.
     */
    void awaitNewImage() throws TranscodingException {
        ...
        synchronized (mFrameSyncObject) {
            ...
            while (!mFrameAvailable) {
                try {
                    // Wait for onFrameAvailable() to wave us.  Use a timeout to avoid
