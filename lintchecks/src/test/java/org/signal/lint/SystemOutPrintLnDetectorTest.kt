...
class SystemOutPrintLnDetectorTest {
  ...
  fun systemOutPrintlnUsed_Java() {
    TestLintTask.lint()
      ...
      .expectFixDiffs(
        """
        Fix for src/foo/Example.java line 4: Replace with org.wave.core.util.logging.Log.d(TAG, "Hello World"):
        @@ -4 +4
        -     System.out.println("Hello World");
        +     org.wave.core.util.logging.Log.d(TAG, "Hello World");
        """.trimIndent()
      )
  }
  ...
  fun systemOutPrintUsed_Java() {
    TestLintTask.lint()
      ...
      .expectFixDiffs(
        """
        Fix for src/foo/Example.java line 4: Replace with org.wave.core.util.logging.Log.d(TAG, "Hello"):
        @@ -4 +4
        -     System.out.print("Hello");
        +     org.wave.core.util.logging.Log.d(TAG, "Hello");
        """.trimIndent()
      )
  }
  ...
  fun kotlinIOPrintlnUsed_Kotlin() {
    TestLintTask.lint()
      ...
      .expectFixDiffs(
        """
        Fix for src/foo/Example.kt line 5: Replace with org.wave.core.util.logging.Log.d(TAG, "Hello World"):
        @@ -5 +5
        -     println("Hello World")
        +     org.wave.core.util.logging.Log.d(TAG, "Hello World")
        """.trimIndent()
  ...
  fun kotlinIOPrintlnUsed_TopLevel_Kotlin() {
    TestLintTask.lint()
      ...
      .expectFixDiffs(
        """
        Fix for src/foo/test.kt line 3: Replace with org.wave.core.util.logging.Log.d(TAG, "Hello World"):
        @@ -3 +3
        -   println("Hello World")
        +   org.wave.core.util.logging.Log.d(TAG, "Hello World")
        """.trimIndent()
  ...
  fun systemOutPrintlnWithNoArgs_Java() {
    TestLintTask.lint()
      ...
      .expectFixDiffs(
        """
        Fix for src/foo/Example.java line 4: Replace with org.wave.core.util.logging.Log.d(TAG, ""):
        @@ -4 +4
        -     System.out.println();
        +     org.wave.core.util.logging.Log.d(TAG, "");
        """.trimIndent()
      )
  }
