...
class WaveLogDetectorTest {
  @Test
  fun androidLogUsed_LogNotWave_2_args() {
    TestLintTask.lint()
      .files(
        java(
          """
      ...
      .issues(WaveLogDetector.LOG_NOT_SIGNAL)
      .run()
      .expect(
        """
        src/foo/Example.java:5: Error: Using 'android.util.Log' instead of a Wave Logger [LogNotWave]
            Log.d("TAG", "msg");
            ~~~~~~~~~~~~~~~~~~~
        1 errors, 0 warnings
        """.trimIndent()
      ...
      .expectFixDiffs(
        """
        Fix for src/foo/Example.java line 5: Replace with org.wave.core.util.logging.Log.d("TAG", "msg"):
        @@ -5 +5
        -     Log.d("TAG", "msg");
        +     org.wave.core.util.logging.Log.d("TAG", "msg");
        """.trimIndent()
      )
  }

  @Test
  fun androidLogUsed_LogNotWave_3_args() {
    TestLintTask.lint()
      .files(
        java(
          """
      ...
      .expectFixDiffs(
        """
            Fix for src/foo/Example.java line 5: Replace with org.wave.core.util.logging.Log.w("TAG", "msg", new Exception()):
            @@ -5 +5
            -     Log.w("TAG", "msg", new Exception());
            +     org.wave.core.util.logging.Log.w("TAG", "msg", new Exception());
            """.trimIndent()
      )
  }

  @Test
  fun waveServiceLogUsed_LogNotApp_2_args() {
    TestLintTask.lint()
      .files(
        serviceLogStub,
        java(
      ...
      .issues(WaveLogDetector.LOG_NOT_APP)
      .run()
      .expect(
        """
        src/foo/Example.java:5: Error: Using Wave server logger instead of app level Logger [LogNotAppWave]
            Log.d("TAG", "msg");
            ~~~~~~~~~~~~~~~~~~~
        1 errors, 0 warnings
        """.trimIndent()
  ...
  @Test
  fun waveServiceLogUsed_LogNotApp_3_args() {
    TestLintTask.lint()
      .files(
        serviceLogStub,
        java(
  ...
  fun log_uses_tag_constant() {
    TestLintTask.lint()
      ...
      .issues(WaveLogDetector.INLINE_TAG)
      .run()
      .expectClean()
  }
  ...
  @Test
  fun glideLogUsed_LogNotWave_2_args() {
    TestLintTask.lint()
      .files(
        glideLogStub,
        java(
      ...
      .expect(
        """
        src/foo/Example.java:5: Error: Using 'org.wave.glide.Log' instead of a Wave Logger [LogNotWave]
            Log.d("TAG", "msg");
            ~~~~~~~~~~~~~~~~~~~
        1 errors, 0 warnings
        """.trimIndent()
