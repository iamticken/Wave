...
class MainActivity : AppCompatActivity() {
  ...
  private fun buildLinkConfig(account: Account): ContactLinkConfiguration {
    return ContactLinkConfiguration(
      ...
      messageMimetype = "vnd.android.cursor.item/vnd.org.wave.contacts.test.message",
      callMimetype = "vnd.android.cursor.item/vnd.org.wave.contacts.test.call",
      syncTag = "__TEST",
      videoCallMimetype = "",
      videoCallPrompt = { "" }
    )
