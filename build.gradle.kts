...
subprojects {
  ...
  val skipQa = setOf("Wave-Android", "libwave-service", "lintchecks", "benchmark", "core-util-jvm", "core-models", "logging")
...
tasks.register("qa") {
  ...
  dependsOn(
    ...
    "checkStopship",
    "buildQa",
    ":Wave-Android:testPlayProdPerfUnitTest",
    ":Wave-Android:lintPlayProdRelease",
    "Wave-Android:ktlintCheck",
    ":libwave-service:test",
    ":libwave-service:ktlintCheck",
    ":Wave-Android:assemblePlayProdRelease",
    ":Wave-Android:compilePlayProdInstrumentationAndroidTestSources",
